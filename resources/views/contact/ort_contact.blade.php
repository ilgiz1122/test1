...
<style>
  ...
  src: url('https://ort.nonsi.kg/public/contact/fonts/montserrat/Montserrat-Regular.ttf'); 
}

@font-face {
  font-family: Montserrat-Bold;
  src: url('https://ort.nonsi.kg/public/contact/fonts/montserrat/Montserrat-Bold.ttf'); 
}

@font-face {
  font-family: Montserrat-ExtraBold;
  src: url('https://ort.nonsi.kg/public/contact/fonts/montserrat/Montserrat-ExtraBold.ttf'); 
}

@font-face {
  font-family: Montserrat-Medium;
  src: url('https://ort.nonsi.kg/public/contact/fonts/montserrat/Montserrat-Medium.ttf'); 
}
        	...
        	<div class="row pt-2 pb-3 ">
        		<div class="col-md-6 text-center">
                  ...
                  <div class="row align-items-center block23">
                      <a href="https://wa.me/+996505919600"></a>
                      <div class="col-auto">

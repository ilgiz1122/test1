...
<head>
    ...
    <script src="{{ asset('public/packages/ckeditor4/ckeditor.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('public/portfolio/files/bower_components/chartist/css/chartist.css') }}"
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/assets/pages/toolbar/jquery.toolbar.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/assets/pages/toolbar/custom-toolbar.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/assets/css/pages.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/bower_components/switchery/css/switchery.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/bower_components/bootstrap-tagsinput/css/bootstrap-tagsinput.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/bower_components/owl.carousel/css/owl.carousel.css') }}">

    <link rel="stylesheet" href="{{ asset('public/portfolio/files/bower_components/select2/css/select2.min.css') }}" />

    <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/bower_components/bootstrap-multiselect/css/bootstrap-multiselect.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('public/portfolio/files/bower_components/multiselect/css/multi-select.css') }}" />
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('public/portfolio/files/bower_components/jquery-ui/js/jquery-ui.min.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ asset('public/portfolio/files/assets/pages/toolbar/jquery.toolbar.min.js') }}"></script>
    

    <script src="{{ asset('public/portfolio/files/assets/js/pcoded.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/portfolio/files/bower_components/modernizr/js/modernizr.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/portfolio/files/bower_components/modernizr/js/css-scrollbars.js') }}"></script>

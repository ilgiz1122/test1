...
<head>
    ...
    <link rel="stylesheet"
        href="https://nonsi.kg/public/admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet"
        href="https://nonsi.kg/public/admin/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <!-- Toastr -->
    <link rel="stylesheet" href="https://nonsi.kg/public/admin/plugins/toastr/toastr.min.css">
    <link rel="stylesheet" href="https://nonsi.kg/public/packages/pull_to_refresh/ptrLight.css">
    <script type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.js"></script>
    <script src="https://nonsi.kg/public/packages/pull_to_refresh/ptrLight.js"></script>
...
<body class="hold-transition sidebar-mini layout-fixed" id="body01" style="background-color: #f4f6f9">
      ...
      <li class="nav-item">
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                <img src="https://nonsi.kg/public/admin/dist/img/logo1.jpg" alt="AdminLTE Logo"
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="https://nonsi.kg/public/admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->

                        ...
                        <div class="card card-outline card-info">
                            ...
                            @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group border required two shadow-sm ml-0 mt-3 mr-0 pt-3 pb-3 pr-2 pl-2 mb-3" style="border-radius: 3px;">
                        ...
                        <div class="sticky-top mb-3">
                            ...
                            <div class="card card-widget widget-user shadow flex-fill">
                              ...
                              <div class="card-header pt-0 pb-0 pl-0 pr-0" style="max-height: 196px;">
                                <img class="" id="rebate_old_imag" style="width: 100%; max-height: 196px; border-top-right-radius: 4px; border-top-left-radius: 4px;" src="/img/net_kartinki2.jpg">
                              </div>
    ...
    $(document).on('click', '.nomer_testa2', function(){    
        // Для добавления вопросов теста
            ...
            if (clicks2 < 1){
                ...
                //Для счета количество тестов
            $("#linksTable").append('<div class="block-text2" id="block-2" style="display: block;"><p class="mb-1">Вставьте ссылку видео (Youtube)</p><input type="text" name="youtube_video" maxlength="100" class="form-control" placeholder="Пример: https://www.youtube.com/watch?v=rcoW4_W4U4U" autocomplete="off"></div>');
            }
        // Для добавления вопросов теста
    });
</script>

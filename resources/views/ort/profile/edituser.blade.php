            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-outline card-widget widget-user1 shadow-lg">
                        <form method="POST" action="{{ route('ort_profile_update', ['subdomain' => 'ort']) }}"  enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="card-body box-profile mt-1">
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b style="color: #28a745;">Атасынын аты</b> <a class="float-right"><input type="text" style="height: 25px; border: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;" class="text-right form-control form-control-border" name="o_fio" value="{{Request::old('o_fio') ?: Auth::user()->o_fio}}" autocomplete="o_fio" autofocus placeholder="Атасынын аты">
                                    </a>
                                </li>
                                <li class="list-group-item pb-0">
                                    <b style="color: #28a745;">Область</b>
                                    <a class="float-right">
                                        <select name="oblast" id="materialcategory_id" class="form-control form-control-border productcategory pt-0 pb-2 text-right" style="border-bottom: none;">
                                ...
                                <li class="list-group-item pb-0">
                                    ...
                                    <a class="float-right">
                                        <select name="raion_shaar" id="materialpodcategory_id" class="form-control form-control-border productname pt-0 pb-2 text-right" style="border-bottom: none;">
                                ...
                                <li class="list-group-item">
                                    <b style="color: #28a745;">Айыл</b> <a class="float-right"><input type="text" style="height: 25px; border: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;" class="text-right form-control form-control-border" name="aiyl_title" value="{{Request::old('aiyl_title') ?: Auth::user()->aiyl_title}}" autocomplete="aiyl_title" autofocus placeholder="Айыл">
                                    </a>
                                </li>
                                <li class="list-group-item">
                                    <b style="color: #28a745;">Мектеп/Мекеме</b> <a class="float-right"><input type="text" style="height: 25px; border: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;" class="text-right form-control form-control-border" name="mektep_title" value="{{Request::old('mektep_title') ?: Auth::user()->mektep_title}}" autocomplete="mektep_title" autofocus placeholder="Мектеп/Мекеме">
                                    </a>
                                </li>
                            </ul>

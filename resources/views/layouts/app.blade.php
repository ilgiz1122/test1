...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="{{ asset('/admin/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.cs') }}s">
  <!-- Toastr -->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        @else
          <a href="{{ route('profil.index')}}" class="dropdown-item">
            <div class="media">
              @if(Auth::user()->img_600_600 != null)
                  <div class="mr-3 mt-2"><img class=" img-circle" src="{{ storage_path('') }}storage/users/img_600_600/{{Auth::user()->img_600_600}}" style="width: 50px;"></div>
              @else
          ...
          <div class="dropdown-divider"></div>
          <a href="{{ route('moi_materialy', ['for_action' => '0'])}}" class="dropdown-item mt-3"><i class="text-muted fas fa-file-powerpoint mr-3"></i> Презентацияларым</a>
          <a href="{{ route('vse_materialy', ['for_action' => '4'])}}" class="dropdown-item"><i class="text-muted fas fa-scroll mr-2"></i> План конспекттерим</a>
          <a href="{{ route('moi_materialy', ['for_action' => '1'])}}" class="dropdown-item"><i class="text-muted fas fa-tasks mr-2"></i> Тест, <small>текшерүү иш, ...</small></a>
          <a href="{{ route('moi_materialy', ['for_action' => '2'])}}" class="dropdown-item"><i class="text-muted fas fa-window-restore mr-2"></i> Шаблондорум  <small>(презентация)</small></a>
          <a href="{{ route('moi_materialy', ['for_action' => '3'])}}" class="dropdown-item"><i class="text-muted fas fa-award mr-3"></i> Грамота, <small>сертификат, ...</small></a>
          <a href="{{ route('moikursy')}}" class="dropdown-item"><i class="text-muted fas fa-chalkboard-teacher mr-2"></i> Курстарым</a>
          <a href="{{ route('moi_testy', ['for_action' => '0'])}}" class="dropdown-item"><i class="text-muted fas fa-spell-check mr-2"></i> Онлайн тесттерим</a>
          <a href="{{ route('moi_testy', ['for_action' => '1'])}}" class="dropdown-item"><i class="text-muted fas fa-graduation-cap mr-2"></i> ЖРТ <small>(тесттерим)</small></a>
          <!-- <a href="{{ route('moi_testy', ['for_action' => '2'])}}" class="dropdown-item mb-3"><i class="text-muted fas fa-spell-check mr-2"></i> НЦТ <small>(тесттерим)</small></a> -->
    ...
    <div class="sidebar">      
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ route('vse_kursy')}}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('vse_materialy', ['for_action' => '0'])}}" class="nav-link">
                    <i class="nav-icon fas fa-file-powerpoint"></i>
                    <p>Презентация</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('vse_materialy', ['for_action' => '4'])}}" class="nav-link">
                    <i class="nav-icon fas fa-scroll"></i>
                    <p>План конспект</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('vse_materialy', ['for_action' => '1'])}}" class="nav-link">
                    <i class="nav-icon fas fa-tasks"></i>
                    <p>Тест, <small>текшерүү иш, ...</small></p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('vse_materialy', ['for_action' => '2'])}}" class="nav-link">
                    <i class="nav-icon fas fa-window-restore"></i>
                    <p>Шаблон <small>(презентация)</small></p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('vse_materialy', ['for_action' => '3'])}}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('vse_testy', ['for_action' => '0'])}}" class="nav-link">
            ...
            <!--<li class="nav-item">
                <a href="{{ route('vse_testy', ['for_action' => '2'])}}" class="nav-link">
                    <i class="nav-icon fas fa-spell-check"></i>
                    <p>НЦТ <small>(тест)</small></p>
                </a>
            </li>-->
            
            
            <li class="nav-item">
                <a href="{{ route('vitrina', ['for_action' => '0'])}}" class="nav-link">
                    <i class="nav-icon fas fa-store"></i>
                    <p>Витрина</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('moderatorlor_for_user')}}" class="nav-link">
            ...
            <li class="nav-item  pb-3">
                <a href="{{ route('jardam')}}" class="nav-link">
            ...
            <li class="nav-item pb-2 pt-2 moderator">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('moi_materialy', ['for_action' => '0'])}}" class="nav-link">
                        <i class="nav-icon fas fa-file-powerpoint"></i>
                        <p>Презентацияларым</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('moi_materialy', ['for_action' => '4'])}}" class="nav-link">
                        <i class="nav-icon fas fa-scroll"></i>
                        <p>План конспекттерим</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('moi_materialy', ['for_action' => '1'])}}" class="nav-link">
                        <i class="nav-icon fas fa-tasks"></i>
                        <p>Тест, <small>текшерүү иш, ...</small></p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('moi_materialy', ['for_action' => '2'])}}" class="nav-link">
                        <i class="nav-icon fas fa-window-restore"></i>
                        <p>Шаблондорум <small>(презентация)</small></p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('moi_materialy', ['for_action' => '3'])}}" class="nav-link">
                        <i class="nav-icon fas fa-award"></i>
                        <p>Грамота, <small>сертификат, ...</small></p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('moi_testy', ['for_action' => '0'])}}" class="nav-link">
                        <i class="nav-icon fas fa-spell-check"></i>
                        <p>Онлайн тесттерим</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('moi_testy', ['for_action' => '1'])}}" class="nav-link">
                        <i class="nav-icon fas fa-graduation-cap"></i>
                        <p>ЖРТ <small>(тесттерим)</small></p>
                    </a>
                </li>
                <!--<li class="nav-item">
                    <a href="{{ route('moi_testy', ['for_action' => '2'])}}" class="nav-link">
                        <i class="nav-icon fas fa-spell-check"></i>
                        <p>НЦТ <small>(тесттерим)</small></p>
                    </a>
                </li>-->
              </ul>
            </li>
            ...
            <li class="nav-item pb-2 pt-2 moderator">
                <a href="{{ route('moderator_panel')}}" class="nav-link" target="_blank">
            ...
            <li class="nav-item pb-2 pt-2 moderator">
              <a href="#" class="nav-link">
                <i class="nav-icon fas fa-solar-panel"></i>
                <p>Админ панель<i class="right fas fa-angle-left"></i></p>
              </a>
              <ul class="nav nav-treeview">
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="{{ route('admin_certificate_users_view')}}" class="nav-link">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>Сертификат</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>Олимпиада <i class="right fas fa-angle-left"></i></p>
                  </a>
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="{{ route('admin_olimpiada_moderators')}}" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>Курс <i class="right fas fa-angle-left"></i></p>
                  </a>
                  <ul class="nav nav-treeview">
                    <li class= >
                    ...
                    <li class="nav-item">
                      <a href="{{ route('podcategory.index')}}" class="nav-link">
                        <i class="nav-icon fas fa-align-left"></i>
                        <p>Подкатегории</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="{{ route('uroky.index')}}" class="nav-link">
                        <i class="nav-icon fas fa-pager"></i>
                        <p>Уроки</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="{{ route('admin_kurs_moderators_settings')}}" class="nav-link">
                        <i class="nav-icon far fa-list-alt"></i>
                        <p>Модераторы</p>
                      </a>
                    </li>
                ...
                <li class="nav-item">
                  <a href="{{ route('vitrina_category', ['for_action' => '0'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Витрина
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('material_category', ['for_action' => '0'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Презентациялар
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('material_category', ['for_action' => '1'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Тесттер
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('material_category', ['for_action' => '2'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Шаблон
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('material_category', ['for_action' => '3'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                ...
                <li class="nav-item">
                  <a href="{{ route('material_category', ['for_action' => '4'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>План конспект</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('test_category', ['for_action' => '0'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Онлайн тест
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('test_category', ['for_action' => '1'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      ЖРТ
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('test_category', ['for_action' => '2'])}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      НЦТ
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('sms_index')}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Билдирүүлөр
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('materialy.index')}}" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                      Материалы
                    </p>

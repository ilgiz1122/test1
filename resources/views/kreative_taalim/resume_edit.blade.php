                    ...
                    <div class="col-md-8">
                        <div class="card card-outline card-info">
                            <div class="card-header"> 
                                <p class="mb-0 text-center"><b>Резюмени оңдоо</b></p>
                            </div>
                            <form id="fileUploadForm" action="{{ route('kreative_taalim_resume_update', $resume->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                <div class="card-body pl-3 pr-3">
                                    <div class="form-row mb-0">      
                                        <div class="form-group col-md-4 mb-0 required mt-5">
                                            <p class="required mb-0">Фамилиясы</p>
                                                <input type="text" name="familya" maxlength="100" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Асанов" value="{{ $resume->familya }}" required autocomplete="off">
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                        </div>
                                        <div class="form-group col-md-4 mb-0 required mt-5">
                                            <p class="required mb-0">Аты</p>
                                                <input type="text" name="aty" maxlength="100" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Асан" value="{{ $resume->aty }}" required autocomplete="off">
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                        </div>
                                        <div class="form-group col-md-4 mb-0 required mt-5">
                                            <p class=" mb-0">Атасынын аты</p>
                                                <input type="text" name="at_aty" maxlength="100" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Асанович" value="{{ $resume->at_aty }}" autocomplete="off">
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-0">      
                                        <div class="form-group col-md-4 mb-0 required mt-5">
                                            <p class="required mb-0">Туулган датасы</p>
                                                <input name="tuulgan_kunu" value="{{ $resume->tuulgan_kunu }}" type="text" class="form-control color1 form-control-border  pr-1 pl-1 pt-2 pb-1"  data-inputmask='"mask": "99.99.9999"' data-mask placeholder="12/09/1996" required="true">
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                        </div>
                                        <div class="form-group col-md-4 mb-0 required mt-5">
                                            <p class="required mb-0">Үй-бүлөлүк абалы</p>
                                                <select name="ui_buloluk_abaly" class="form-control productname form-control-border  pr-1 pl-1 pt-2 pb-0" required="">
                                                    ...
                                                    <option value="2" @if($resume->ui_buloluk_abaly == 2) selected @endif>үй-бүлөлүү</option>
                                                    <option value="1" @if($resume->ui_buloluk_abaly == 1) selected @endif>бойдок</option>
                                                </select>
                                            <div class="invalid-feedback">Тандаңыз!</div>
                                        </div>
                                        <div class="form-group col-md-4 mb-0 required mt-5">
                                            <p class="required mb-0">Жалпы педагогикалык стажы</p>
                                            <input type="number" pattern="\d+" name="staj" min="0" max="99999" maxlength="5" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Мисалы: 12 " value="{{ $resume->staj }}" required>
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-0">
                                        <div class="form-group col-md-6 mb-0 required mt-5">
                                            <p class="mb-0">Email</p>
                                                <input type="email" name="email" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="asan@gmail.com" value="{{ $resume->email }}" autocomplete="off">
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                        </div>
                                        <div class="form-group col-md-6 mb-0 required mt-5">
                                            ...
                                            <div class="row align-items-end hover1">
                                              ...
                                              <div class="col pl-0">
                                                <input name="whatsapp" value="{{ $resume->whatsapp }}" type="text" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-1 color1" data-inputmask='"mask": "(999) 999-999"' data-mask placeholder="(700) 999-999">
                                              </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-5 required">
                                        <p class="required mb-0">Азыркы ээлеген кызматы</p>
                                                <input type="text" name="azyrky_kyzmaty" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Математика мугалими" value="{{ $resume->azyrky_kyzmaty }}" required autocomplete="off">
                                            <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                    </div>
                                    ...
                                    <div class="bilimi mt-5">
                                        ...
                                        <div id="bilimi_pole">
                                            ...
                                            <div id="bilimi_1" class="row align-items-center mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="bilimi[]" rows="1" class="form-control" placeholder="Билими" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                                @if($loop->iteration != 1)
                                                <div class="col-auto pl-0"><i class="fas fa-trash btn btn-tool pr-0 bilimi_delet"></i></div>
                                                @endif
                                            </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="tajryiba mt-5 pt-5">
                                        ...
                                        <div id="tajryiba_pole">
                                            ...
                                            <div id="tajryiba_1" class="row align-items-center mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="tajryiba[]" rows="1" class="form-control" placeholder="Иш тажрыйбасы" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                    ...
                                    <div class="ozgocho_tajryiba mt-5">
                                        ...
                                        <div id="ozgocho_tajryiba_pole">
                                            ...
                                            <div id="ozgocho_tajryiba_1" class="row align-items-center mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="ozgocho_tajryiba[]" rows="1" class="form-control" placeholder="Иш тажрыйбасы" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                                <div class="col-auto pl-0">
                                                    <i class="fas fa-trash btn btn-tool pr-0 ozgocho_tajryiba_delet"></i>
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="gramota_syilyk mt-5 pt-5">
                                        ...
                                        <div id="gramota_syilyk_pole">
                                            ...
                                            <div id="gramota_syilyk_1" class="row align-items-center  mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="gramota_syilyk[]" rows="1" class="form-control" placeholder="Сыйлыктары" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                                <div class="col-auto pl-0">
                                    ...
                                    <div class="sertificate_syilyk mt-5">
                                        ...
                                        <div id="sertificate_syilyk_pole">
                                            ...
                                            <div id="sertificate_syilyk_1" class="row align-items-center mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="sertificate_syilyk[]" rows="1" class="form-control" placeholder="Сыйлыктары" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                                <div class="col-auto pl-0">
                                                    <i class="fas fa-trash btn btn-tool pr-0 sertificate_syilyk_delet"></i>
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="naam_syilyk mt-5">
                                        ...
                                        <div id="naam_syilyk_pole">
                                            ...
                                            <div id="naam_syilyk_1" class="row align-items-center mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="naam_syilyk[]" rows="1" class="form-control" placeholder="Сыйлыктары" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                                <div class="col-auto pl-0">
                                                    <i class="fas fa-trash btn btn-tool pr-0 naam_syilyk_delet"></i>
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="emgek mt-5 pt-5">
                                        ...
                                        <div id="emgek_pole">
                                            ...
                                            <div id="emgek_1" class="row align-items-center mt-2">
                                                <div class="col-auto pr-1">
                                                    <i class="fas fa-genderless pr-0" style="font-size: 12px;"></i>
                                                </div>
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="emgek[]" rows="1" class="form-control" placeholder="Эмгектери" required>{!! $resume_dop_info1->info !!}</textarea>
                                                </div>
                                                <div class="col-auto pl-0">
                                    ...
                                    <div id="ssylka_pole">
                                        @foreach ($resume_dop_info->where('type_info', 5) as $resume_dop_info1)
                                            <div id="ssylka_1" class="mb-3 p-1 border" style="border-radius: 4px;">
                                                <div class="card-tools text-right">
                                                    <i class="fas fa-trash btn btn-tool pr-0 ssylka_delet pr-2"></i>
                                                </div>
                                                <div class="form-row mb-0 pb-1">
                                                    <div class="form-group col-md-6 required mb-0 mt-2">
                                                        <p class="required mb-0">Аталышы</p>
                                                        <input type="text" name="ssylka_title[]" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Web сайт, портфолио" value="{{ $resume_dop_info1->title }}" required autocomplete="off">
                                                        <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                                    </div>
                                                    <div class="form-group col-md-6 required mb-0 mt-2">
                                                        <p class="required mb-0">Шилтемеси</p>
                                                        <input type="text" name="ssylka_adress[]" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="https://my_sait.kg" value="{{ $resume_dop_info1->info }}" required autocomplete="off">
                                                        <div class="invalid-feedback">Сөзсүз толтуруу керек!</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" mt-3">
                                                ...
                                                <div class="form-group align-items-center">
                                                    <div class="custom-file">
                                                        ...
                                                        <span class="custom-file-label" for="rebate_imag" data-browse="Выбрать">@if($resume->img != null){{$resume->img}} @else Выберите картинку @endif</span>
                                    ...
                                    <div class="y_vidoe mt-0 pt-5">
                                        ...
                                        @if(count($resume_dop_info->where('type_info', 6)) > 0)
                                            @foreach ($resume_dop_info->where('type_info', 6) as $resume_dop_info1)
                                            <div class="row align-items-end hover1">
                                                <div class="col-auto pr-0">
                                                ...
                                                <div class="col pl-0">
                                                    <input name="y_vidoe2[]" value="{{ $resume_dop_info1->info }}" type="text" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-1 color1" placeholder="https://www.youtube.com/watch?v=WVhXideBUAI">
                                                </div>
                                            </div>
                                            @endforeach
                                        @else
                                            <div class="row align-items-end hover1">
                                                ...
                                                <div class="col pl-0">
                                                    <input name="y_vidoe2[]" value="{{ old('y_vidoe2') }}" type="text" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-1 color1" placeholder="https://www.youtube.com/watch?v=WVhXideBUAI">
                                                </div>
                                            </div>
                                        @endif
                                    </div>

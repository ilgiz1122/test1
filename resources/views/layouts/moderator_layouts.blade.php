...
<aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('moderator_panel')}}" class="brand-link">
        <img src="{{asset('')}}/admin/dist/img/logo1.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light"><strong>Модератор панел</strong></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">      
      <!-- Sidebar Menu -->
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="{{ route('moderator_profile_index_for_moderator')}}" class="nav-link">
...
<script type="text/javascript" src="//cdn.datatables.net/keytable/2.1.1/js/dataTables.keyTable.min.js"></script>

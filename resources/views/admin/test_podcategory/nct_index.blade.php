            ...
            <div class="row mb-2">
                ...
                <div class="col-auto">
                    <div class="card-tools">
                        <a class="btn btn-sm btn-success" href="{{ route('nct_podcat_create', $test_categories->id)}}">
                ...
                <table class="table table-head-fixed table-hover text-nowrap">
                    ...
                    <tbody class="align-middle">
                       @foreach ($test_podcategories as $test_podcategories)
                        <tr class="todo-list2">
                            <td class="align-middle"><img class="img-svg mt-2 mb-2 mr-3 ml-2" src="{{asset('')}}/{{$test_podcategories['img']}}"></td>
                            <td class="align-middle">{{$test_podcategories['id']}}</td>
                            <td class="align-middle">{{$test_podcategories['title']}}</td>
                            <td class="align-middle">{{$test_podcategories->testy_count}} <a class="btn btn-tool w-1001  tools2" type="button" href="{{ route('nct_podcat_index', $test_podcategories['id'])}}"><i class="fas fa-long-arrow-alt-right" style="font-size: 1em;"></i></a></td>
                            <td class="align-middle">
                                <!--<a class="btn btn-tool w-1001  tools2" type="button" >
                                    <i class="far fa-eye" style="font-size: 1.2em;"></i>
                                </a>-->
                              
                                <a class="btn btn-tool tools2" href="{{route('nct_podcat_edit', $test_podcategories['id'])}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Редактировать">
                                  <i class="far fa-edit" style="font-size: 1.2em;"></i>
                                </a>
                                <a type="button" class="btn btn-tool w-10000 w-1001 tools2" data-bs-toggle="tooltip" data-bs-placement="top" title="Удалить" data-toggle="modal" @if($test_podcategories->testy_count > 0) data-target="#staticBackdrop2" @else data-target="#staticBackdrop" data-title="{{$test_podcategories['title']}}" data-id="{{route('nct_podcat_destroy', $test_podcategories->id)}}" data-kol="{{$test_podcategories->testy_count}}" @endif>

            ...
            @if (count($reklams) > 0)
                <div class="pcoded-inner-content row scroll infinite-scroll">
                    @foreach ($reklams as $reklama)
                        <div class="col-md-3 col-12 d-flex px-lg-3 py-lg-2 " style="padding-left: 7px; padding-right: 7px;">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <a href="https://wa.me/+996505919600"
                        style="color: #f2f7fb; font-weight: 550 !important; font-size: 0.9375rem">
                        <div class="row align-items-center mt-30">
                            <div class="col-auto"><i class="fas fa-layer-group fa-lg"></i></div>
    ...
    <script>
        ...
        $(function() {
            ...
            $('.infinite-scroll').jscroll({
                autoTrigger: true,
                loadingHtml: '<div style="margin-bottom: 30px; margin-top: 30px; margin-left: 42.5vw !important;"><i class="fad fa-spinner fa-pulse fa-lg" style="--fa-primary-color: #1f62d6; --fa-secondary-color: #1f62d6; font-size: 15vw;"></i></div>',
                padding: 1400,

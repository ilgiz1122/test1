            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6 pl-3 pr-3">
                        ...
                        <p class="text-muted mb-0">Баасы <span class="float-right">{{$podcategories['price'] / 100}} сом</span></p><hr class="mt-2">
            ...
            @endif
                ...
                <div class="shadow-lg collapse @error('promocod') show @enderror" id="collapseExample">
                  <div class="card card-body pt-3">
                    ...
                    <form action="{{route('proverka_kursa', $podcategories['id'])}}" method="POST">
                        @csrf

                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card mb-0 for_video_and_img"
                                                        style="background-image: url('{{ asset('public/img/loader.gif') }}'); width:100%; height:100%;">
                                                        <img class="card-img-top img-fluid img_net_img"
                                                            src="{{ asset('public/img/not_img.png') }}" alt="Сүрөт жок"
                                                            style="display: none;">
                                    ...
                                    @foreach ($urok_frames as $urok_frame)
                                        <div class="frame border pt-5 pb-5 pl-5 pr-5 mb-10 mt-40"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card mb-0 for_video_and_img">
                                                        <img class="card-img-top img-fluid img_net_img" src="{{ asset('public/img/no_frame.png') }}" alt="Сүрөт жок" style="display: none;">

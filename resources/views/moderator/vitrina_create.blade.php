...
@section('title', 'Добавить витрину')
                                ...
                                <div class="card-body pl-3 pr-3">
                                    ...
                                    <div class="for_adres_1">
                                        <div class="row align-items-top mt-5">
                                            <div class="col required">
                                                <p class="required mb-1"><span class="span_adres_dostavki"></span></p>
                                            </div>
                                            <div class="col-auto opisanie_bottom">
                                                <i id="bilimi_click" class="fa-solid fa-plus btn btn-tool pr-0" style="font-size: 15px;"></i>
                                            </div>
                                        </div><hr class="mt-0">
                                        <div class="pr-0 pl-0" id="adres_dostavki_pole">
                                            <div id="adres_dostavki_1" class="row align-items-center mt-0 ml-0 mr-0">
                                                <div class="col-auto pr-1"><i class="fa-regular fa-genderless pr-0" style="font-size: 12px;"></i></div> 
                                                <div class="col pr-0 pl-0">
                                                    <textarea name="adres_dostavki[]" rows="1" class="form-control form-control-border pr-1 pl-1 pt-2 pb-1 color1" placeholder="Даректердин тизмесин жазыңыз" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="media">
                                            <div class="media-body">
                                              <h3 class="dropdown-item-title pt-2 pb-2">
                                                Telegram
                                                <span class="float-right text-sm"><i class="fa-solid fa-paper-plane btn btn-tool" style="font-size: 25px;"></i></span>
                                              </h3>
                                            </div>
                                          </div>
                                        </button>
                                    ...
                                    <div class="form-group file_hide_telefram mb-0 required mt-3">
                                        <div class="row align-items-top">
                                            ...
                                            <div class="col-auto">
                                                <span id="telegram_clear"><i class="fas fa-trash btn btn-tool pr-0"></i></span>
                                            </div>
                                        </div>
                                        <div class="row align-items-end hover1">
                                          <div class="col-auto pr-0">
                                            <p class="form-control form-control-border color1 pr-0 pl-1 pt-2 pb-0 mb-0"><i class="fa-solid fa-paper-plane pr-3" style="color: green;"></i> https://t.me/</p> 
                                          </div>
                                          <div class="col pl-0">
                                    ...
                                    <div class="file_hide_youtube required mt-5">
                                        <div class="row align-items-top">
                                            ...
                                            <div class="col-auto">
                                                <span id="youtube_clear" ><i class="fas fa-trash btn btn-tool pr-0"></i></span>
                                            </div>
                                        </div>
                                        <div>
...
<script type="text/javascript">
    ...
    $("#select1").on('change',function(){
        ...
        $("#bilimi_click").click(function () {
            ...
            $("#adres_dostavki_pole").append('<div id="' + inputsCounter01 + '" class="row align-items-center mt-2 ml-0 mr-0"><div class="col-auto pr-1"><i class="fa-regular fa-genderless pr-0" style="font-size: 12px;"></i></div><div class="col pr-0 pl-0"><textarea name="adres_dostavki[]" rows="1" class="form-control form-control-border pr-1 pl-1 pt-2 pb-1 color1" placeholder="Даректердин тизмесин жазыңыз" required></textarea></div><div class="col-auto pl-0 pr-0"><i class="fas fa-trash btn btn-tool pr-0 adres_dostavki_delet"></i></div></div>');
            $(document).ready(function() {autosize(document.querySelectorAll('textarea')); });

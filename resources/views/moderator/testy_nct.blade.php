    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row align-items-center mb-3 pt-3">
            ...
            <div class="col-2" >
              <a class="btn btn-sm btn-success float-right text-nowrap" data-bs-toggle="tooltip" data-bs-placement="left" title="Добавить тест" href="{{ route('moderator_tests_nct_create')}}">
                ...
                <div class="col-md-9">
                  <div class="row mr-0 ml-0  align-items-center"> 
                    ...
                    <div class="col-md-1 text-right tools2 dropup" style="line-height: 2.2rem; word-spacing: 30px;">
                          ...
                          <a class="btn btn-tool" href="{{ route('moderator_tests_nct_edit', $test['id']) }}">

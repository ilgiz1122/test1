                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card card-outline card-info">
                            ...
                            <form id="fileUploadForm2" action="{{ route('moderator_materials_update2', $materialy['id']) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')

        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-12 block23 two for_color_navedenii px-lg-2 py-lg-2">
                  @if ($for_action == 1)
                      <a style="display:block"  href="{{ route('ort_negizgi_test_podcat', ['subdomain' => 'ort', 'id' => $test_podcategory->id]) }}"></a>
                  @endif
                  @if ($for_action == 2)
                  ...
                  @endif
                    <div class="info-box shadow-sm for_shadow" style="background: Light;">
                        <span class="info-box-icon"><img class="img-svg mt-2 mb-2 mr-3 ml-2"  src="https://ort.nonsi.kg/public/{{$test_podcategory['img']}}"></span>

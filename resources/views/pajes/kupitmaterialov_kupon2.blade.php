        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <p class="text-muted mb-3 mt-5">{!! $materialies->opisanie !!}</p>
                    <div class="row mt-3">
                        <div class="col-md-6 pl-2 pr-2">
                            <div class="card">
                                <div class="card-body">
                                    <p class="text-muted mb-0">Автор <span class="float-right">{{$materialies->user['name']}}</span></p><hr class="mt-1">
                                    <p class="text-muted mb-0">Язык <span class="float-right">{{$materialies->languages['language']}}</span></p><hr class="mt-1">
                        ...
                        <div class="col-md-6 pl-2 pr-2">
                            <div class="card">
                                <div class="card-body">
                                    <p class="text-muted mb-0">Цена <span class="float-right"><del class="pr-2 text-red">({{$materialies->price / 100}} сом)</del> {{$materialies->price / 100 * 0.9}} сом</span></p><hr class="mt-1">
                                    <p class="text-muted mb-0">Количество скачиваний <span class="float-right">{{$materialies->kol_skachek}}</span></p><hr class="mt-1">
                                    <p class="text-muted mb-0">Количество покупок <span class="float-right">{{$kupitmaterialovs}}</span></p><hr class="mt-1 mb-0">
                                </div>
                            </div>
                            ...
                            @if (Auth::user())
                                @if (Auth::user()->balance >= $materialies->price * 0.9)
                                    <!--<a href="{{ route('store_kupon', [$materialies->id, $proverka2->id])}}" class="btn btn-block btn-info pt-1 mb-3">Сатып алуу</a>-->
                ...
                <div class="col-md-3">
                    <div class="sticky-top mb-3">
                        <h6 class="text-muted text-center mb-0 pt-3 pb-2"><b>Презентацияны кантип сатып алса болот?</b></h6>
                        <div class="card card-body pt-2 pb-0 mb-2 mt-2 two">
                            <div class="row align-items-center block23">
                                ...
                                <div class="col">
                                    <p class="text-muted text-center mb-0 pt-2"><b>Написать через WhatsApp</b></p>
                        ...
                        <div class="card card-body pt-2 pb-0  mb-2 mt-4 two">
                            <div class="row align-items-center  block23">
                                ...
                                <div class="col">
                                    <p class="text-muted text-center mb-0 pt-2"><b>Написать через Telegram</b></p>
        ...
        <div class="modal-content ">
          ...
          <div class="modal-body">
            <p class="text-center mb-0 pt-2 pb-2">Чындап эле сатып алууну каалайсызбы?</p>
                ...
                <p class="text-muted mb-0">Баасы <span class="float-right"><del class="pr-2 text-red">({{$materialies->price / 100}} сом)</del> {{$materialies->price / 100 * 0.9}} сом</span></p><hr class="mt-0">
            
          </div>
          <div class="modal-footer" style="background: #f4f6f9;">
            <a href="{{ route('store_kupon', [$materialies->id, $proverka2->id])}}" class="btn btn-block btn-info pt-1">Сатып алуу</a>
          </div>
        </div>
      </div>
    </div>

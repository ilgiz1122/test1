    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('testy.index')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('materialpodcategory.index')}}" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p>
                Материал подкатегории
              </p>
            </a>
          </li>
...
<script type="text/javascript" src="/admin/dist/js/bootstrap-filestyle.js"></script>

                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="m-0"><b>Добавить категорию (p)</b></h5>
                        </div>
                        <form action="{{ route('material_category_store', $for_action) }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <input type="number" name="dop_category" value="{{$for_action}}" hidden="">

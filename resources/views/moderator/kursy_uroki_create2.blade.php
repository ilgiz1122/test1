                    ...
                    <div class="col-md-8">
                        <div class="card card-outline card-info">
                            <div class="card-header">
                                <p class="mb-0 text-center"><b>Окно добавления урока</b></p>
                            </div>
                            <form id="fileUploadForm" action="{{ route('moderator_kurs_urok_store', $podcategory->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                                <div class="card-body">
                                    <div class="form-group required">
                                        <label class="">Название урока</label>
                                            <input type="text" id='files2' name="title" maxlength="100" class="form-control" placeholder="Введите название урока" onkeyUp="document.getElementById('div').innerHTML = this.value" required autocomplete="off" value="">
                                    ...
                                    <div class="form-group">
                                        <label>Текстовый материал урока</label>
                                            <textarea name="text_uroka" id="summernote"></textarea>
                                    </div>
                                                ...
                                                <td class="pt-0 pb-0 pl-0 pr-0">
                                                    <div class="border shadow-sm two2 required ml-0 mr-0 pt-2 pb-3 pr-2 pl-2 mb-3" id="" style="border-radius: 3px;">
                                                        ...
                                                        <div class="block-text2" id="block-2" style="display: block;">
                                                            <input type="text" name="youtube_video_title[]" maxlength="100" class="form-control" placeholder="Введите название видео" required autocomplete="off">
                                                            <div class="valid-feedback">Заполнено</div>
                                                        ...
                                                        <div class="block-text2 pt-3" id="block-2" style="display: block;">
                                                            ...
                                                            <input type="text" name="youtube_video_ssylka[]" maxlength="100" class="form-control" placeholder="https://www.youtube.com/watch?v=rcoW4_W4U4U" required autocomplete="off">
                                                            <div class="valid-feedback">Заполнено</div>
                                ...
                                <div class="card-footer text-right">
                                    <div class="row">
                                        <button value="submit" name="submit" type="submit" class="btn btn-block btn-info">Создать урок</button>
                                    </div>
                                </div>
                            </form>
...
//<!-- для добавления поле видео --> 
    ...
    $(document).on('click', '.for_video', function(){   
            ...
            if (document.getElementById("clicks").innerHTML < 3){
                ...
                $("#linksTable").append('<tr><td class="pt-0 pb-0 pl-0 pr-0"><div class="border shadow-sm two2 required ml-0 mr-0 pt-2 pb-3 pr-2 pl-2 mb-3" id="" style="border-radius: 3px;"><div class="card-header ui-sortable-handle pt-0 pr-0 pl-0 pb-2" style="border-bottom: none;"><p class="card-title" style=" font-size: 16px;">Название видео</p><div class="card-tools"><button type="button" class="btn btn-tool remove-tr" onClick="clickM()" data-bs-toggle="tooltip" data-bs-placement="left" title="Удалить поле"><i class="fas fa-trash"></i></button></div></div><div class="block-text2" id="block-2" style="display: block;"><input type="text" name="video_title[]" maxlength="100" class="form-control" placeholder="Введите название видео" required autocomplete="off"><div class="valid-feedback">Заполнено</div><div class="invalid-feedback">Введите название видео</div></div><div class="block-text2 pt-3" id="block-2" style="display: block;"><p class="mb-1">Загрузите видео с компьютера (телефона)</p><div class="custom-file"><input type="file" class="custom-file-input" name="video_name[]" accept=".mp4, .mpg, .mpeg, .wmv, .mov, .avi, .ogg, .qt" required><span class="custom-file-label" for="uploadInput" data-browse="Выбрать">Видео не выбрана</span><div class="valid-feedback">Выбрано</div><div class="invalid-feedback">Загрузите рекламное видео курса</div></div></div></div></td></tr>');
                $(document).ready(function () {
                  bsCustomFileInput.init()
                })
            }

            ...
            <section class="content-header pl-0 pr-0">
              <div class="container-fluid p-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h5> Менин баракчам</h5>
                    </div>
                    <div class="col-auto">
                        <button class="btn btn-default btn-tool pt-2 pb-2 pl-2 pr-2 float-right" type="button" onclick="copytext('#text1')"><i class="fas fa-link pr-3" style="font-size: 20px;"></i> Шилтемени көчүрүү</button>
                    </div>
                </div>

  ...
  display: none;
    ...
    <div class="content-header">
        <section class="content-header pl-0 pr-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{$urok->title}} (тест кошуу)</li>
            </ol>
        </section>
    ...
    <!-- Тема -->
        ...
        <section class="preorder-snails content">
                <div class="row">
                    <div class="col-md-9">
                        <form id="fileUploadForm" action="{{ route('moderator_tests_store', $for_action) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                        
                            <h5 class="mb-0 text-center"><b>Тест түзүү</b></h5>
                                <div class="form-group mt-4 pt-3">
                                    <label class="required">Тема</label>
                                        <input type="text" id='files2' name="title" maxlength="100" class="form-control" required placeholder="Тесттин аталышы" autocomplete="title" value="{{ $urok->title }}">
                                        <div class="invalid-feedback">Тесттин аталышын жазыңыз!</div>
                                </div>

                                <div class="form-group mt-4 pt-3">
                                    <div class="required"><label>Описание</label></div>                                        
                                        <textarea name="opisanie" id="summernote" required>{{ $urok->title }} темасы боюнча тест</textarea>
                                ...
                                <div class="form-row form-group mt-4 pt-3">
                                    <div class="form-group col-md-6 mb-0">
                                        <p class="mb-1">Мүмкүндүктөрдүн саны <small>(попытки)</small></p>
                                            <input type="number" pattern="\d+" name="popytki" min="0" max="99999" maxlength="5" class="form-control strelki" placeholder="Мисалы: 3" value="">
                                            <span class="res"></span>
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <div class="card sticky-top">
                                            <div class="card-body p-2">
                                                <div class="row align-items-center ">
                                                    <div class="col">
                                                        <h7 align="center"><strong>Тесттин суроолору </strong>(<span><a id="clicks">1</a> / 30</span>)</h7>
                                                    </div>
                                                    <div class="col-auto">
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                ...
                                                                                <div class="col-auto">
                                                                                    <label class="custom-file-upload p-0 m-0">
                                                                                        <input type="file" class="upload" id="rebate_image1" name="rebate_image1" readonly="" required title="Нажмите чтобы загрузить картинку теста"><i class="fas fa-image btn-tool pl-0 pr-0 mb-2"></i>
                                                                                    </label>
                                                                                </div>
                                                                            </div>

                            ...
                            <h5 class="mb-0 text-center"><b>Тестти өзгөртүү</b></h5>
                                <div class="form-group required mt-4 pt-3">
                                    <label class="">Тема</label>
                                        <input type="text" id='files2' name="title" maxlength="100" class="form-control" placeholder="Тесттин аталышы" onkeyUp="document.getElementById('div').innerHTML = this.value" required autocomplete="title" value="{{ $test->title }}">
                                ...
                                <div class="form-row form-group mt-4 pt-3">      
                                    ...
                                    <div class="form-group col-md-4 mb-0 required">
                                        ...
                                        <select name="test_category_id" id="test_category_id" class="form-control productcategory" required="">
                                            <?php
                                                $podcat2 = $test->test_category_id;
                                            ?>
                                            <option value="" disabled="true" selected="true">Категорияны тандаңыз</option>
                                            @foreach ($test_categories as $test_category)
                                            <option @if ($podcat2 == $test_category->id) selected @endif value="{{ $test_category->id }}">{{$test_category->title}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-4 mb-0 required">
                                        ...
                                        <select name="test_podcategory_id" id="test_podcategory_id" class="form-control productcategory" required="">
                                            <?php
                                                $podcat3 = $test_podcategories->where('id', $test->test_podcategory_id)->first();
                                            ?>
                                                <option value="{{ $test->test_podcategory_id }}">{{$podcat3->title}}</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4 mb-0 required">
                                        ...
                                        <select name="language" class="form-control" required="">
                                            ...
                                            <option value="{{$language->id}}" @if ($language->id == $test->language) selected @endif>{{$language->language}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group required mt-4 pt-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="rebate_imag" name="rebate_imag" title="Сүрөттү өзгөртүү үчүн басыңыз" accept=".jpeg, .jpg, .tiff, .png, .gif, .webp">
                                        <span class="custom-file-label" for="rebate_imag" data-browse="Изменить">{{$test->img}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-row form-group mt-4 pt-3">      
                                    <div class="form-group col-md-4 mb-0 required">
                                        ...
                                        <input type="number" pattern="\d+" name="price" min="0" max="99999" maxlength="5" class="form-control strelki" id="firstname3" placeholder="Мисалы: 100" onkeyUp="document.getElementById('div2').innerHTML = this.value" value="{{$test->price / 100}}" required>
                                        <span class="res"></span>
                                        <div class="invalid-feedback">Баасын коюңуз</div>
                                    </div>
                                    <div class="form-group col-md-4 mb-0">
                                        <p class="mb-1">Мүмкүндүктөрдүн саны</p>
                                        <input type="number" pattern="\d+" name="popytki" min="0" max="99999" maxlength="5" class="form-control strelki" placeholder="Мисалы: 3" onkeyUp="document.getElementById('for_popytki').innerHTML = this.value" value="{{$test->kol_popytkov}}">
                                        <span class="res"></span>
                                    </div>
                                    <div class="form-group col-md-4 mb-0">
                        ...
                        <div class="sticky-top mb-3">
                            ...
                            <div class="card card-widget widget-user flex-fill">
                              ...
                              <div class="card-header pt-0 pb-0 pl-0 pr-0" style="max-height: 196px;">
                                <img class="" id="rebate_old_imag" style="width: 100%; max-height: 196px; border-top-right-radius: 4px; border-top-left-radius: 4px;" src="https://nonsi.kg/public/storage/testy/images/thumbnail/{{$test->img}}">
                              </div>

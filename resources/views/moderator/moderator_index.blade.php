...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <section class="content">
        <div class="container-fluid pb-3">
            ...
            @endif
            <h5 class="pt-3 mb-3">Модератор панел</h5>
            ...
            <div class="row">
              ...
              <section class="col-md-4 connectedSortable mb-3">
                  <div class="info-box mb-0" tabindex="0" role="button" data-html="true" data-toggle="popover" data-trigger="focus" data-placement="top">

            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <form action="{{ route('test_podcat_update', ['for_action' => $for_action, 'id' => $test_podcategory->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <img id="img2" src="https://nonsi.kg/public/{{$test_podcategory['img']}}" alt="" class="img-svg">
                                    </div>
                                    <div class="col">

                                ...
                                <div class="card-body pl-3 pr-3">
                                    ...
                                    <div class="form-row m-0">
                                        ...
                                        <div class="form-group col-md-6 mb-0 required mt-5 align-items-top">
                                            <p class="required mb-0">Турдун башталыш датасы</p>
                                            <div class="row align-items-top hover1">
                                              ...
                                              <div class="col pl-0">
                                                <input name="data_nachalo_tura" value="{{date('d/m/Y (H:i)', $olimpiada_tury->nachalo_zdachi_tura)}}" type="text" class="form-control color1 form-control-border  pr-1 pl-1 pt-2 pb-1" data-inputmask='"mask": "99/99/9999  (99:99)"' data-mask placeholder="25/05/2025  (16:00)" required="true">
                                                <span class="res"></span>
                                                <div class="invalid-feedback">Турдун башталыш датасын көрсөтүңүз!</div>
                                              </div>
                                            </div>
                                        </div>
                                    </div>

                            ...
                            @csrf
                                <div class="card-body pl-3 pr-3">
                                    ...
                                    <div class="form-group required m-0" id="adres_dostavki">
                                        <div class="adres_dostavki mt-5">
                                            <div class="row align-items-top">
                                                <div class="col">
                                                    <p class="required mb-1">@if($vitrina->type_dostavki === 1) Кайсыл даректерден алып кетишсе болот? @endif @if($vitrina->type_dostavki === 2) Кайсыл аймактарга жеткирип бере аласыз? @endif @if($vitrina->type_dostavki === 3) Кайсыл аймактарга акысыз жеткирип бере аласыз? @endif  </p>
                                                </div>
                                                <div class="col-auto opisanie_bottom">
                                                    <i id="opisanie_text_d" class="fas fa-pencil-alt btn btn-tool pr-0"></i>
                                                    <i id="opisanie_text_summernot_d" class="fas fa-trash btn btn-tool pr-0"></i>
                                                </div>
                                            </div>
                                            <div id="opisanie_text00_d">
                                                <div id="ttrr_d">
                                                    <textarea name="adres_dostavki" id="summernote_d" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-0" required>{!! $vitrina->adres_dostavki !!}</textarea>
                                    ...
                                    <div class="form-group file_hide_telefram mb-0 required mt-3">
                                        ...
                                        <div class="row align-items-end hover1">
                                          ...
                                          <div class="col pl-0">
                                            <input name="telegram" value="{{ $vitrina->telegram }}" id="for_telefram_input" type="text" class="form-control form-control-border pr-1 pl-0 pt-2 pb-1 color1" placeholder="ilgiz1209">

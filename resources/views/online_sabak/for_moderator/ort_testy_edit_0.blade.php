                                ...
                                <div class="card-block pb-2 pt-2 pr-3 pl-3 class11 parent_variant">
                                    <div class="row align-items-top mt-15">
                                        <div class="col text112 pr-0">
                                            <textarea class="text11 pt-5 pb-5 vopros_testa summernote" rows="1" placeholder="Тесттин суроосун жазыңыз"
                                    ...
                                    @foreach ($test_otvetys->where('test_voprosy_id', $test_voprosys[$key]->id) as $test_otvety)
                                        <div class="row text1122 align-items-center variant_hover"
                                            ...
                                            <div class="col pr-0">
                                                <textarea class="variant_text summernote2" rows="1" cols="100%" placeholder="Бош вариант" name="variant_text"
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('.summernote').summernote({
                ...
                lang: 'ru-RU',
                placeholder: 'Тесттин суроосун жазыңыз',
                disableDragAndDrop: false,
                tooltip: false,
                popover: {
                    air: [
        ...
        $(document).ready(function() {
            $('.summernote').on('summernote.change', function(we, contents, $editable) {
                ...
                var test_id = $(this).attr('data-test_id');
                let vopros_testa = $(this).summernote('code');
        ...
        $(document).ready(function() {
            $('.summernote2').on('summernote.change', function(we, contents, $editable) {
                var test_otvety_id = $(this).attr('data-test_otvety_id');
                var test_id = $(this).attr('data-test_id');
                let variant_text = $(this).summernote('code');
            ...
            $(".summernote2").on("summernote.paste", function(e,ne) {
                var bufferText = ((ne.originalEvent || ne).clipboardData || window.clipboardData).getData('Text');
                ne.preventDefault();
                document.execCommand('insertText', false, bufferText);
            });
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    $('#' + test_voprosy_id).children('.parent_variant').append(
                        ...
                        '"><span class="cr mr-0" style="border-radius: 50%;"><i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i></span></label></div></div><div class="col pr-0"><textarea class="text11 variant_text summernote2" rows="1" cols="100%" placeholder="Жаңы вариант" name="variant_text" data-test_otvety_id="' +
                ...
                success: function(data) {
                    if (data) {
                        $('.append_vopros').append('<div class="card" id="' + data.test_vopros_id +
                            ...
                            '"> <span class="cr mr-0" style="border-radius: 50%;"> <i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i> </span> </label> </div> </div> <div class="col pr-0"> <textarea class="text11 variant_text summernote2" rows="1" cols="100%" placeholder="Бош вариант" name="variant_text" data-test_otvety_id="' +
                            data.test_otvet1_id +
                            '" data-test_id="{{ $test->id }}"><p>А</p></textarea> </div> <div class="col-auto card-tools"> <i role="button" class="fas fa-times btn-tool delet_variant delet_variant1" data-test_otvety_id="' +
                            data.test_otvet1_id +
                            ...
                            '"> <span class="cr mr-0" style="border-radius: 50%;"> <i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i> </span> </label> </div> </div> <div class="col pr-0"> <textarea class="text11 variant_text summernote2" rows="1" cols="100%" placeholder="Бош вариант" name="variant_text" data-test_otvety_id="' +
                            data.test_otvet2_id +
                            '" data-test_id="{{ $test->id }}"><p>Б</p></textarea> </div> <div class="col-auto card-tools"> <i role="button" class="fas fa-times btn-tool delet_variant delet_variant1" data-test_otvety_id="' +
                            data.test_otvet2_id +
                            '" data-test_id="{{ $test->id }}"></i> </div> </div> <div class="row align-items-center variant_hover text1122" id="test_otvety' +
                            data.test_otvet3_id +
                            '"> <div class="col-auto pr-0"> <div class="checkbox-zoom zoom-primary mr-0"> <label class="mb-0"> <input type="checkbox" value="1" class="variant_check" name="' +
                            ...
                            '"> <span class="cr mr-0" style="border-radius: 50%;"> <i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i> </span> </label> </div> </div> <div class="col pr-0"> <textarea class="text11 variant_text summernote2" rows="1" cols="100%" placeholder="Бош вариант" name="variant_text" data-test_otvety_id="' +
                            data.test_otvet3_id +
                            '" data-test_id="{{ $test->id }}"><p>В</p></textarea> </div> <div class="col-auto card-tools"> <i role="button" class="fas fa-times btn-tool delet_variant delet_variant1" data-test_otvety_id="' +
                            data.test_otvet3_id +
                            '" data-test_id="{{ $test->id }}"></i> </div> </div> <div class="row align-items-center variant_hover text1122" id="test_otvety' +
                            data.test_otvet4_id +
                            '"> <div class="col-auto pr-0"> <div class="checkbox-zoom zoom-primary mr-0"> <label class="mb-0"> <input type="checkbox" value="1" class="variant_check" name="' +
                            ...
                            '"> <span class="cr mr-0" style="border-radius: 50%;"> <i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i> </span> </label> </div> </div> <div class="col pr-0"> <textarea class="text11 variant_text summernote2" rows="1" cols="100%" placeholder="Бош вариант" name="variant_text" data-test_otvety_id="' +
                            data.test_otvet4_id +
                            '" data-test_id="{{ $test->id }}"><p>Г</p></textarea> </div> <div class="col-auto card-tools"> <i role="button" class="fas fa-times btn-tool delet_variant delet_variant1" data-test_otvety_id="' +
                            data.test_otvet4_id +

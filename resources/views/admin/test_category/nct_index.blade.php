            ...
            <div class="row mb-2">
                ...
                <div class="col-auto">
                    <div class="card-tools">
                        <a class="btn btn-sm btn-success" href="{{ route('nct_category_create')}}">

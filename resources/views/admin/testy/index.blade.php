...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-10">
                    <h1 class="m-0">Все тесты</h1>
                </div>
                <div class="col">
                    <a class="btn btn-success btn-block btn-lg" href="{{ route('testy.create')}}">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td class="text-truncate" style="max-width: 250px;" data-bs-toggle="tooltip" data-bs-placement="top" title=""></td>
                            <td></td>
                            <td></td>
                            <td class="project-actions text-right">
                                <a class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Редактировать" href="">
                                    <i class="fas fa-edit"></i>
                                </a>
                            </td>
                            <td class="project-actions text-right">
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Удалить" data-toggle="modal" data-target="#staticBackdrop" data-id="" value="" onclick="newVal(this)">

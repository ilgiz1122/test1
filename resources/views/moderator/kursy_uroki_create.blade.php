    ...
    <div class="content">
            <section class="content-header pl-0 pr-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Сабак кошуу</li>
                </ol>
            </section>
                        ...
                        <div class="card card-outline card-info">
                            ...
                            @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group border two2 mt-4 pt-3 pb-1 pr-2 pl-2" style="border-radius: 3px;">
                                    ...
                                    <div class="mt-4 pt-3 pb-1" id="">
                                        <div class="card-header ui-sortable-handle pt-0 pr-0 pl-0 pb-2" style="border-bottom: none;">
                                            ...
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool for_youtube_video" style=" font-size: 16px;"><i class="fab fa-youtube"></i> Добавить поле</button>
                                            </div>
                                        </div>
                                    </div> 

                ...
                <div class="col-md-9">
                  <div class="row mr-0 ml-0  align-items-center"> 
                      ...
                      <div class="card-body pr-2 pl-2 pt-3 pb-3">
                        ...
                        <div class="row align-items-center ml-0 mr-0 mt-3">
                          ...
                          <div class="col border text-center shadow-sm two dropup">
                            ...
                            <p class="card-text pb-1"><small class="text-muted"><span style="word-spacing: 10px;">Цена: <b>{{$test->price / 100}}</b></span> сом</small></p>
                            </a>
                            <!-- dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2 pr-2 pl-2">Цена теста</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                          ...
                          <div class="col border text-center shadow-sm two dropup" style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;">
                            ...
                            <!-- dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2">Статус теста</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                    ...
                    <div class="col-md-1 text-right tools2" style="line-height: 2.2rem; word-spacing: 30px;">
                          <!--<a class="btn btn-tool w-1001" href="{{ route('moderator_kurs_urok_index', $test['id']) }}">
                          ...
                          <a class="btn btn-tool w-1001 for_modal_delete" type="button" data-toggle="modal" data-target="#staticBackdrop" data-title="{{ $test->title }}" data-kol="{{$test->tests_kupit_count}}" data-price="{{ $test->price / 100 }}" data-id2="{{route('moderator_tests_destroy', $test['id'])}}">

    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="row align-items-center mb-3 pt-3">
            <div class="col-10" >
              <h5 class="pt-2 mb-2">Список туров <span data-bs-toggle="tooltip" data-bs-placement="right" title="Количество олимпиад">({{count($olimpiada_tury)}})</span></h5>
            </div>
            <div class="col-2" >
              @if(count($olimpiada_tury) <= 5)
              <a class="btn btn-sm btn-success float-right text-nowrap" data-bs-toggle="tooltip" data-bs-placement="left" title="Добавить товар" href="{{ route('moderator_olimpiada_tury_create', $olimpiada['id'])}}">
                  ...
                  <div class="row mr-0 ml-0  align-items-center"> 
                    <div class="col-md-11 pr-0 pl-0">
                      <div class="card-body pr-2 pl-2 pt-3 pb-2">
                        <div class="row">
                          <div class="col">
                            <h6 class=" text-truncate" title="{{$olimpiada->title}}">№{{$loop->iteration}}. {{$olimpiada->title}}</h6>
                          </div>
                          <div class="col-auto">
                                <!-- Main content 
                        ...
                        <small class="text-muted"> Башталышы: {{date('d.m.Y', $olimpiada->nachalo_zdachi_tura)}} ({{date('H:i', $olimpiada->nachalo_zdachi_tura)}})</small></p>
                        
                        <p class="card-text text-muted mb-0 mt-1">Категория: </p>
                        <div class="row align-items-center ml-0 mr-0 mt-3">
                          <div class="col border text-center shadow-sm two dropup" style="border-top-left-radius: 3px; border-bottom-left-radius: 3px;">
                            <a class="" data-toggle="dropdown" id="dropdownMenuOffset2" type="button"  data-offset="194,15">
                              <p class="card-text pb-1"><small class="text-muted"><span style="word-spacing: 15px;">Телефон: </span>
                                  <span class="badge"><i class="fas fa-phone-alt" style="font-size: 13px; color: #28a745;"></i></span>
                              </small></p>
                            </a>
                            <!-- dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              ...
                              <form class="" method="POST" action="{{ route('moderator_vitrina_update_phone_for_zvonok', $olimpiada['id']) }}">
                              @csrf
                              @method('PUT')
                                <div class="row align-items-end hover1 ml-2 mr-2">
                                  ...
                                  <div class="col pl-0 pr-0">
                                    <input name="phone_for_zvonok" value="" type="text" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-1 color1" data-inputmask='"mask": "(999) 999-999"' data-mask placeholder="(700) 999-999" required="true">
                                  </div>
                                </div>
                          ...
                          <div class="col border text-center shadow-sm two dropup">
                            <a class="" data-toggle="dropdown" id="dropdownMenuOffset10" type="button"  data-offset="115,15">
                              <p class="card-text pb-1"><small class="text-muted"><span style="word-spacing: 15px;">WhatsApp: </span>
                                  <span class="badge"><i class="fab fa-whatsapp" style="font-size: 13px; color: #dc3545;"></i></span>
                              </small></p>
                            </a> 
                            <!-- dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              ...
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form class="" method="POST" action="{{ route('moderator_vitrina_update_phone_for_whatsapp', $olimpiada['id']) }}">
                              @csrf
                              @method('PUT')
                                <div class="row align-items-end hover1 ml-2 mr-2">
                                  <div class="col-auto pr-0 pl-0">
                                  ...
                                  <div class="col pl-0 pr-0">
                                    <input name="phone_for_whatsapp" value="" type="text" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-1 color1" data-inputmask='"mask": "(999) 999-999"' data-mask placeholder="(700) 999-999">
                                  </div>
                                </div>
                                <div class="pt-2 pb-2 pr-2 pl-2 mb-2">
                                  <button type="submit" class="btn btn-info btn-sm float-right">Сактоо</button>
                          ...
                          <div class="col border text-center shadow-sm two dropup">
                            ...
                            <p class="card-text pb-1"><small class="text-muted"><span style="word-spacing: 10px;">Баасы: <b>{{$olimpiada->price / 100}}</b></span> сом</small></p>
                            </a>
                            <!-- dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2 pr-2 pl-2">Баасы</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form class="" method="POST" action="{{ route('moderator_vitrina_update_price', $olimpiada['id']) }}">
                              @csrf
                              @method('PUT')
                                <div class="input-group pt-2 pb-2 pr-2 pl-2">
                                  <input type="number" pattern="\d+" name="price" min="0" max="99999" maxlength="5" class="form-control" placeholder="Например: 30 " value="{{$olimpiada->price / 100}}">
                          ...
                          <div class="col border text-center shadow-sm two dropup" style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-right pt-0 pb-0">
                              ...
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form method="POST" action="{{ route('moderator_vitrina_update_status1', $olimpiada['id']) }}">
                              @csrf
                              @method('PUT')
                              ...
                              <form method="POST" action="{{ route('moderator_vitrina_update_status0', $olimpiada['id']) }}">
                              @csrf
                              @method('PUT')
                    ...
                    <div class="col-md-1 text-right tools2" style="line-height: 2.2rem; word-spacing: 30px;">
                          <a class="btn btn-tool w-1001" href="{{ route('moderator_kurs_urok_index', $olimpiada['id']) }}">
                            <span style="font-size: 1.2em;" data-toggle="tooltip" data-placement="left" title="Уроки даннога курса">
                              <i class="fas fa-list-ul"></i>
                            </span>
                          </a>

                          <a class="btn btn-tool" role="button" href="{{ route('moderator_kurs_dostijenie_studentov', $olimpiada['id']) }}">
                          ...
                          <a class="btn btn-tool" href="{{ route('moderator_vitrina_edit', ['for_action' => 1, 'id' => $olimpiada['id']]) }}">
          ...
          @foreach ($olimpiada_tury as $olimpiada2)
                  ...
                  <div class="row mr-0 ml-0  align-items-center"> 
                    <div class="col-md-11 pr-0 pl-0">
                      <div class="card-body pr-2 pl-2 pt-3 pb-2">
                        <div class="row">
                          <div class="col">
                            <h6 class=" text-truncate" title="{{$olimpiada2->title}}">№{{$loop->iteration}}. {{$olimpiada2->title}}</h6>
                          </div>
                          <div class="col-auto">
                                <!-- Main content 
                            <a class="btn btn-tool w-1001" href="{{ route('moderator_kurs_certificate', $olimpiada2['id']) }}">
                              <span style="font-size: 1.4em;" data-toggle="tooltip" data-placement="left" title="Сертификат">
                                <i class="fas fa-award"></i>
                              </span>
                            </a>-->
                        ...
                        <p class="text-truncate mb-0"  style="max-width: 500px;">
                        <small class="text-muted"> Башталышы: {{date('d.m.Y', $olimpiada2->nachalo_zdachi_tura)}} ({{date('H:i', $olimpiada2->nachalo_zdachi_tura)}})</small></p>
                        ...
                        <div class="row align-items-center ml-0 mr-0 mt-3">
                          <div class="col border text-center shadow-sm two dropup" style="border-top-left-radius: 3px; border-bottom-left-radius: 3px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2 pr-2 pl-2">Телефон (чалуу үчүн)</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form class="" method="POST" action="{{ route('moderator_vitrina_update_phone_for_zvonok', $olimpiada2['id']) }}">
                              @csrf
                              @method('PUT')
                                <div class="row align-items-end hover1 ml-2 mr-2">
                                  <div class="col-auto pr-0 pl-0">
                          ...
                          <div class="col border text-center shadow-sm two dropup">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2 pr-2 pl-2">WhatsApp номер</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form class="" method="POST" action="{{ route('moderator_vitrina_update_phone_for_whatsapp', $olimpiada2['id']) }}">
                              @csrf
                              @method('PUT')
                                <div class="row align-items-end hover1 ml-2 mr-2">
                                  <div class="col-auto pr-0 pl-0">
                          ...
                          <div class="col border text-center shadow-sm two dropup">
                            <a class="" data-toggle="dropdown" id="dropdownMenuOffset3" type="button"  data-offset="50,15">
                            <p class="card-text pb-1"><small class="text-muted"><span style="word-spacing: 10px;">Баасы: <b>{{$olimpiada2->price / 100}}</b></span> сом</small></p>
                            </a>
                            <!-- dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2 pr-2 pl-2">Баасы</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form class="" method="POST" action="{{ route('moderator_vitrina_update_price', $olimpiada2['id']) }}">
                              @csrf
                              @method('PUT')
                                <div class="input-group pt-2 pb-2 pr-2 pl-2">
                                  <input type="number" pattern="\d+" name="price" min="0" max="99999" maxlength="5" class="form-control" placeholder="Например: 30 " value="{{$olimpiada2->price / 100}}">
                                  <div class="input-group-append">
                                    <span class="input-group-text">сом</span>
                                  </div>
                                </div>
                          ...
                          <div class="col border text-center shadow-sm two dropup" style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-right pt-0 pb-0">
                              <p class="h3 dropdown-item-title text-center pt-2 pb-2">Статус курса</p>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                              <form method="POST" action="{{ route('moderator_vitrina_update_status1', $olimpiada2['id']) }}">
                              @csrf
                              @method('PUT')
                                <input type="number" name="status" min="0" max="1" maxlength="1" class="form-control" value="1" hidden="">
                                <button type="submit"  class="dropdown-item">
                                  ...
                                  <div class="media">
                                    <div class="media-body">
                                      <h3 class="dropdown-item-title pt-2 pb-2">
                                        Активный
                                        <span class="float-right text-sm">@if (intval($olimpiada2->status) == 1)<i class="far fa-check-square" style="font-size: 20px; color: #28a745;"></i>@else<i class="far fa-square" style="font-size: 20px; color: #28a745;"></i>@endif</span>
                                      </h3>
                              ...
                              <form method="POST" action="{{ route('moderator_vitrina_update_status0', $olimpiada2['id']) }}">
                              @csrf
                              @method('PUT')
                                <input type="number" name="status2" min="0" max="1" maxlength="1" class="form-control" value="0" hidden="">
                                <button type="submit"  class="dropdown-item">
                                  ...
                                  <div class="media">
                                    <div class="media-body">
                                      <h3 class="dropdown-item-title pt-2 pb-2">
                                        Скрытый
                                        <span class="float-right text-sm">@if (intval($olimpiada2->status) == 0)<i class="far fa-check-square" style="font-size: 20px; color: #28a745;"></i>@else<i class="far fa-square" style="font-size: 20px; color: #28a745;"></i>@endif</span>
                                      </h3>
                                    </div>
                                  </div>
                                  <!-- Message End -->
                    ...
                    <div class="col-md-1 text-right tools2" style="line-height: 2.2rem; word-spacing: 30px;">
                          <a class="btn btn-tool w-1001" href="{{ route('moderator_kurs_urok_index', $olimpiada2['id']) }}">
                            <span style="font-size: 1.2em;" data-toggle="tooltip" data-placement="left" title="Уроки даннога курса">
                              <i class="fas fa-list-ul"></i>
                            </span>
                          </a>

                          <a class="btn btn-tool" role="button" href="{{ route('moderator_kurs_dostijenie_studentov', $olimpiada2['id']) }}">
                            <span style="font-size: 1.2em;" data-toggle="tooltip" data-placement="left" title="Достижение студентов">
                              <i class="far fa-chart-bar"></i>
                            </span>
                          </a>
                          ...
                          <a class="btn btn-tool" href="{{ route('moderator_vitrina_edit', ['for_action' => 1, 'id' => $olimpiada2['id']]) }}">
                            <span style="font-size: 1.2em;" data-toggle="tooltip" data-placement="left" title="Редактировать">
                              <i class="far fa-edit" style="transform: scale(-1, 1);"></i>
                            </span>
                          </a>
                          <a class="btn btn-tool w-1001 for_modal_delete" type="button" data-toggle="modal" data-target="#staticBackdrop" data-title="{{ $olimpiada2->title }}" data-kol="{{$olimpiada2->kupit_count}}" data-price="{{ $olimpiada->price / 100 }}" data-id2="{{route('moderator_vitrina_destroy', $olimpiada2['id'])}}">
                            <span style="font-size: 1.2em;" data-toggle="tooltip" data-placement="left" title="Удалить">
                              <i class="fas fa-trash"></i>
                            </span>
                          </a>

            ...
            <div class="row mb-2">
                ...
                <div class="col-auto">
                    <div class="card-tools">
                        <a class="btn btn-sm btn-success" href="{{ route('vitrina_podcat_create', ['for_action' => $for_action, 'id' => $materialcategories->id])}}">
                       ...
                       @foreach ($materialpodcategories as $materialpodcategories)
                        <tr class="todo-list2">
                            ...
                            <td class="align-middle">
                                ...
                                <a class="btn btn-tool tools2" href="{{route('vitrina_podcat_edit', ['for_action' => $for_action, 'id' => $materialpodcategories->id])}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Редактировать">
                                  <i class="far fa-edit" style="font-size: 1.2em;"></i>
                                </a>
                                <a type="button" class="btn btn-tool w-10000 w-1001 tools2" data-bs-toggle="tooltip" data-bs-placement="top" title="Удалить" data-toggle="modal" data-target="#staticBackdrop" data-title="{{$materialpodcategories['title']}}" data-id="{{route('vitrina_podcategory_destroy', ['for_action' => $for_action, 'id' => $materialpodcategories->id])}}" data-kol="{{$materialpodcategories->materialy_count}}">

...
<style>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                    <h1 class="m-0">Подкатегориялар ({{$materialcategories->title}})</h1>
                </div>
                <div class="col-auto">
                    <div class="card-tools">
                        <a class="btn btn-sm btn-success" href="{{ route('material_podcat_create', ['for_action' => $for_action, 'id' => $materialcategories->id])}}">
                       ...
                       @foreach ($materialpodcategories as $materialpodcategories)
                        <tr class="todo-list2">
                            ...
                            <td class="align-middle">
                                ...
                                <a class="btn btn-tool tools2" href="{{route('material_podcat_edit', ['for_action' => $for_action, 'id' => $materialpodcategories->id])}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Редактировать">
                                  <i class="far fa-edit" style="font-size: 1.2em;"></i>
                                </a>
                                <a type="button" class="btn btn-tool w-10000 w-1001 tools2" data-bs-toggle="tooltip" data-bs-placement="top" title="Удалить" data-toggle="modal" @if($materialpodcategories->materialy_count > 0) data-target="#staticBackdrop2" @else data-target="#staticBackdrop" data-title="{{$materialpodcategories['title']}}" data-id="{{route('material_podcategory_destroy', ['for_action' => $for_action, 'id' => $materialpodcategories->id])}}" data-kol="{{$materialpodcategories->materialy_count}}" @endif>

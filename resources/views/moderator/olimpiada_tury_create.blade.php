                    ...
                    <div class="col-md-9">
                        <div class="card card-outline card-info">
                            <div class="card-header"> 
                                <p class="mb-0 text-center"><b>{{$olimpiada_tur_count + 1}}-тур</b></p>
                            </div>
                            <form id="fileUploadForm" action="{{ route('moderator_olimpiada_tury_store', $olimpiada['id']) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                                    ...
                                    <div class="form-row m-0">
                                        <div class="form-group col-md-6 mb-0 required mt-5">
                                            <p class="required mb-0">Баасы (сом)</p>
                                                <input type="number" pattern="\d+" name="price" min="0" max="99999" maxlength="5" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" id="firstname3" placeholder="Мисалы: 100 " value="{{ old('price') }}" required>
                                                <span class="res"></span>

                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-outline card-info pt-0 pb-0">
                            ...
                            <form id="fileUploadForm" action="{{ route('banner_store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                                <div class="card-body pt-0 pb-0">
                                    <div class="form-group required pt-2">
                                        <label>Тема материала</label>
                                            <input type="text" name="title" maxlength="100" class="form-control" placeholder="Введите тему материала" onkeyUp="document.getElementById('div').innerHTML = this.value" required autocomplete="off">
                                    ...
                                    <div class="form-group mt-0 pt-0 required">
                                        <label>Краткое описание материала</label>
                                            <textarea type="text" name="opisanie" maxlength="255" style="height: 100px;" class="form-control" id="firstname2" placeholder="Описание (максимум 255 символов)" required onkeyUp="document.getElementById('div2').innerHTML = this.value"></textarea>
                                        <div class="valid-feedback">Заполнено</div>
                                    ...
                                    <div class="form-group mt-0 pt-0">
                                        <label>Ссылка</label>
                                        <input type="text" name="ssylka" maxlength="255" class="form-control" placeholder="Введите ссылку" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="required">
                                        ...
                                        <div class="form-group align-items-center">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="rebate_imag" name="img" accept=".jpeg, .jpg, .tiff, .png, .gif, .webp" required>
                        ...
                        <div class="sticky-top mb-3">
                                <div class="card mb-2 bg-gradient-dark" style="border-radius: 10px;">
                                  ...
                                  <div class="card-img-overlay d-flex flex-column justify-content-end">
                                    ...
                                    <p class="card-text text-white pb-1 pt-3" id="div2">Описание рекламы</p>

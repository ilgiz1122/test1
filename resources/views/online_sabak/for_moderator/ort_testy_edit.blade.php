...
@section('content')
    ...
    <div class="pcoded-inner-content">
        ...
        <div class="tab-content card-block pr-0 pl-0 pb-5">
            <div class="tab-pane" id="tab_pole3" role="tabpanel">
                ...
                <div class="card">
                    <div class="card-block">
                        <div class="row align-items-center hover_b_color">
                            <div class="col-auto mt-15">
                                <div class="d-inline-block align-middle b_color">
                                    <p class=""><b>Формуласы бар редактор</b>  <i class="fal fa-info-circle pl-10"
                                        type="button" data-toggle="tooltip" data-placement="top"
                                        title="Математика, физика, химия ж.б. предметтер үчүн формула киргизүү мүмкүнчүлүгү"
                                        style="color: #007bff"></i></p>
                                </div>
                            </div>
                            <div class="col border-bottom"></div>
                            <div class="col-auto pb-5 ">
                                <span class="float-right pb-5 redaktor_formul" data-test_id="{{ $test->id }}">
                                    <input id="redaktor_formul" type="checkbox"
                                        class="js-small js-switch js-primary pb-5"
                                        @if ($test->redaktor_formul == 1) checked @endif />
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach ($test_voprosys as $key => $value)
                            <div class="card" id="{{ $test_voprosys[$key]->id }}">
                                <div class="card-header pr-15 pl-15 pb-10 pt-10 border-bottom">
                                    <div class="row">
                                        <div class="col-auto pr-0"><p class="mb-0">№</p></div>
                                        <div class="col p-0">
                                            <p class="mb-0">
                                        ...
                                        <div class="col-auto text-muted p-0">
                                            <i class="fas fa-grip-horizontal mob_vid"></i>
                                        </div>
                                        <div class="col p-0">
                                ...
                                <div class="card-block pb-2 pt-2 pr-3 pl-3 class11 parent_variant">
                                    <div class="row align-items-top mt-15">
                                        <div class="col text112 pr-0">
                                            <textarea id="edit_{{ $test_voprosys[$key]->id }}" class="text11 pt-5 pb-5 vopros_testa edotor_demo" name="vopros_testa" data-id="{{ $test_voprosys[$key]->id }}" data-test_id="{{ $test->id }}" placeholder="Тесттин суроосу ...">{!! $test_voprosys[$key]->text_voprosa !!}</textarea>
                                            <hr class="m-0 p-0">
                                        </div>
                                    ...
                                    @foreach ($test_otvetys->where('test_voprosy_id', $test_voprosys[$key]->id) as $test_otvety)
                                        <div class="row text1122 align-items-center variant_hover"
                                            ...
                                            <div class="col pr-0">
                                                <textarea id="edit2_{{ $test_otvety->id }}" rows="1" cols="100%" id="" class="text11 variant_text edotor_demo" placeholder="Бош вариант" name="variant_text" data-test_otvety_id="{{ $test_otvety->id }}" data-test_id="{{ $test->id }}">{!! $test_otvety->test_otvety !!}</textarea>
                                            </div>
                                        ...
                                        <script>
                                            var edit2_{{ $test_otvety->id }} = CKEDITOR.inline('edit2_{{ $test_otvety->id }}', {
                                                extraPlugins: 'autogrow,ckeditor_wiris,justify',
                                                language: 'ru',
                                                ...
                                                allowedContent : true,
                                                // mathTypeParameters: {
                                                //     editorParameters: { language: 'ru' }, // MathType config, including language
                                                // },
                                                on: {
                                                    change: function( evt ) {
                                                        let variant_text = edit2_{{ $test_otvety->id }}.getData();
                                                        $.ajax({
                                                            url: "/moderator_panel_ort/test/" + {{ $test->id }} + '/otvet_testa/' + {{ $test_otvety->id }} + '/update',
                                                            type: "PUT",
                                                            data: {
                                ...
                                <div class="card-footer border-top pb-2 pt-2 pr-3 pl-3 ">
                                    <div class="row">
                                        <div class="col">
                                            <p class="mb-0 text-center variant_plus1" data-test_id="{{ $test->id }}"
                            ...
                            <script>
                                var edit_{{ $test_voprosys[$key]->id }} = CKEDITOR.inline('edit_{{ $test_voprosys[$key]->id }}', {
                                    ...
                                    on: {
                                        change: function( evt ) {
                                            let vopros_testa = edit_{{ $test_voprosys[$key]->id }}.getData();
                                            $.ajax({
                                                url: "/moderator_panel_ort/test/" + {{ $test->id }} + '/vopros_testa/' + {{ $test_voprosys[$key]->id }} +
                                                    '/update',
                                                type: "PUT",
                                                data: {
    ...
    <script>
        ...
        $(".redaktor_formul").click(function() {
            var test_id = $(this).attr('data-test_id');
            $.ajax({
                url: "/moderator_panel_ort/test/" + test_id + '/redaktor_formul',
                type: "GET",
                dataType: "json",
                success: function(response) {
                    console.log(response);
                    if (response == 0) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Редакторду кайра алмаштырууга болбойт'
                        });
                    }else{
                        location.reload();
                    }
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    $('#' + test_voprosy_id).children('.parent_variant').append(
                        '<div class="row align-items-center variant_hover text1122" id="test_otvety' +
                        result +
                        ...
                        '"><span class="cr mr-0" style="border-radius: 50%;"><i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i></span></label></div></div><div class="col pr-0"><textarea id="" rows="1" cols="100%" class="text113 variant_text variant_text2" placeholder="Жаңы вариант" name="variant_text" data-test_otvety_id="' + result + '" data-test_id="' + test_id + '"></textarea></div><div class="col-auto card-tools"><i role="button" class="fas fa-times btn-tool delet_variant delet_variant1" data-test_otvety_id="' +
                        result + '" data-test_id="' + test_id + '"></i></div></div>');

                    autosize($('textarea'));

                    $('.variant_text2').focus(function() {
                        $(".variant_text2").attr('id', '');
                        $(this).attr('id', 'editor_variant_text2');
                        var vopros_otvet_id = $(this).attr('data-test_otvety_id');
                        var test_id = $(this).attr('data-test_id');
                        var editor_variant_text2 = CKEDITOR.inline('editor_variant_text2', {
                            language: 'ru',
                            extraPlugins: 'autogrow,ckeditor_wiris,justify',
                            autoGrow_minHeight: 200,
                            autoGrow_maxHeight: 600,
                            ...
                            on: {
                                change: function( evt ) {
                                    let variant_text = editor_variant_text2.getData();
                                    $.ajax({
                                        url: "/moderator_panel_ort/test/" + test_id + '/otvet_testa/' + vopros_otvet_id + '/update',
                                        type: "PUT",
                                        data: {
                                            variant_text: variant_text,
                                            _token: "{{ csrf_token() }}",
                ...
                success: function(data) {
                    if (data) {
                        $('.append_vopros').append('<div class="card" id="' + data.test_vopros_id +
                            '"><div class="card-header pr-15 pl-15 pb-10 pt-10 border-bottom"> <div class="row"> <div class="col-auto pr-0"><p class="mb-0">№</p></div> <div class="col p-0"> <p class="mb-0"><input name="katar_nomeri" type="text" style="background: none; border: none;" data-test_id="{{ $test->id }}" data-test_voprosy_id="' + data.test_vopros_id + '" class="strelki autonumber num_nomber" id="num_nomber' + data.test_vopros_id + '" data-a-sign="" data-p-sign="s" data-a-Sep="" data-a-Pad="false" data-l-Zero="deny" data-v-Min="0" data-v-Max="100000" readonly value="' + data.test_vopros_katar_nomeri + '"></p> </div> <div class="col-auto text-muted p-0"> <i class="fas fa-grip-horizontal mob_vid"></i> </div> <div class="col p-0"> </div> <div class="col-auto pl-0"> <div class="card-tools"> <button type="button" class="btn btn-tool remove-vopros" data-test_voprosy_id="' + data.test_vopros_id + '" data-test_id="{{ $test->id }}"><i class="fas fa-trash"></i></button> </div> </div> </div> </div> <div class="card-block pb-2 pt-2 pr-3 pl-3 class11 parent_variant"> <div class="row align-items-top mt-15"> <div class="col text112 pr-0"> <textarea id="" cols="1" rows="1" class="text1102 pt-5 pb-5 vopros_testa" name="vopros_testa" data-id="' + data.test_vopros_id + '" data-test_id="{{ $test->id }}" placeholder="Тесттин суроосу ..."></textarea> <hr class="m-0 p-0"></div> <div class="col-auto  sos-st-card1 twitter"> <form action="#" method="POST" enctype="multipart/form-data" class="form1" data-test_voprosy_id="' +
                            data.test_vopros_id +
                            ...
                            data.test_vopros_id +
                            '" data-test_id="{{ $test->id }}" type="button"></i> </div> </div> </div> <div class="mt-40"></div> <div class="row align-items-center variant_hover text1122" id="test_otvety' +
                            data.test_otvet1_id +
                            '"> <div class="col-auto pr-0"> <div class="checkbox-zoom zoom-primary mr-0"> <label class="mb-0"> <input type="checkbox" value="1" class="variant_check" name="' +
                            data.test_vopros_id + '" data-test_voprosy_id="' + data.test_vopros_id +
                            '" data-test_otvety_id="' + data.test_otvet1_id +
                            '"> <span class="cr mr-0" style="border-radius: 50%;"> <i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i> </span> </label> </div> </div> <div class="col pr-0"> <textarea id="" class="text113 variant_text variant_text2" rows="1" cols="100%" placeholder="Бош вариант" name="variant_text" data-test_otvety_id="' +
                            data.test_otvet1_id +
                            ...
                            data.test_otvet1_id +
                            '" data-test_id="{{ $test->id }}"></i> </div> </div> <div class="row align-items-center variant_hover text1122" id="test_otvety' +
                            data.test_otvet2_id +
                            '"> <div class="col-auto pr-0"> <div class="checkbox-zoom zoom-primary mr-0"> <label class="mb-0"> <input type="checkbox" value="1" class="variant_check" name="' +
                            data.test_vopros_id + '" data-test_voprosy_id="' + data.test_vopros_id +
                        ...
                        $('.vopros_testa').focus(function() {
                            $(".vopros_testa").attr('id', '');
                            $(this).attr('id', 'editor');
                            if($('.vopros_testa').hasClass('edotor_demo')){
                                $('.vopros_testa').removeClass('edotor_demo');
                            }
                            ...
                            var editor = CKEDITOR.inline('editor', {
                                ...
                                on: {
                                    change: function( evt ) {
                                        let vopros_testa = editor.getData();
                                        $.ajax({
                        ...
                        $('.variant_text2').focus(function() {
                            ...
                            var editor_variant_text2 = CKEDITOR.inline('editor_variant_text2', {
                                ...
                                editorplaceholder: 'Тесттин суроосу ...',
                                autoGrow_minHeight: 200,
                                autoGrow_maxHeight: 600,
                                autoGrow_bottomSpace: 50,
                                removePlugins: 'resize',
                            ...
                            jQuery.ajax({
                                ...
                                success: function(result) {
                                    $('#' + test_voprosy_id).children(
                                        ...
                                        test_voprosy_id +
                                        '" data-test_otvety_id="' + result +
                                        '"><span class="cr mr-0" style="border-radius: 50%;"><i class="cr-icon icofont icofont-ui-check txt-default" style="font-size: 9px; padding-top: 1px;"></i></span></label></div></div><div class="col pr-0"><textarea id="" class="text113 variant_text variant_text2" rows="1" cols="100%" placeholder="Жаңы вариант" name="variant_text" data-test_otvety_id="' +

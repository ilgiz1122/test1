        ...
        <section class="preorder-snails content">
                        <div class="card card-outline card-info">
                            <div class="card-header">
                                <p class="mb-0 text-center"><b>Базага сертификат кошуу</b></p>
                            </div>
                            <form id="fileUploadForm" action="{{ route('admin_certificate_users_plus_store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('POST')
                                <div class="card-body p-2">
                                    <div class="form-group mt-2 pt-3">
                                        <label>Текст сертификата</label>
                                        <textarea name="text_certificata" id="summernote"></textarea>
                                    </div>
                                <div class="form-row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col icheck-success d-inline input-group" align="center">
                                                        <input type="radio" name="rol" id="r1a" value="1" checked="">
                                                        <label for="r1a">Ручной</label>
                                                    </div>
                                                    <div class="col icheck-success d-inline input-group" align="center">
                                                        <input type="radio" name="rol" id="r1b" value="0">
                                    ...
                                    <div class="form-group col-md-4 required align-items-top border two2 mt-4 pt-3 pb-1 pr-2 pl-2" style="border-radius: 3px;">
                                        ...
                                        <div class="row align-items-top hover1">
                                          ...
                                          <div class="col pl-0">
                                            <input name="data" value="{{ old('data') }}" type="text" class="form-control color1 form-control-border  pr-1 pl-1 pt-2 pb-1" data-inputmask='"mask": "99/99/9999"' data-mask placeholder="25/05/2025" required="true">
                                            <span class="res"></span>
                                    ...
                                    <div class="sticky-top card card-body mt-4 pt-2 pb-1" id="">
                                        <div class="card-header ui-sortable-handle pt-0 pr-0 pl-0 pb-2" style="border-bottom: none;">
                                            <h7 class="card-title" style=" font-size: 16px;"><b>ФИО</b> (max: 50)</h7>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool for_youtube_video" style=" font-size: 16px;"><i class="fas fa-plus pr-2"></i> Кошуу</button>
                                            </div>
                                        </div>
                                    </div> 
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-10">
                                                                <div class="block-text2" id="block-2" style="display: block;">
                                                                    <input type="text" name="fio[]" maxlength="100" class="form-control" placeholder="ФИО" required autocomplete="off">
                                                                    <div class="invalid-feedback">ФИО жазылган жок</div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="block-text2" id="block-2" style="display: block;">
                                                                    <input type="number" name="number[]" min="20000000" max="99999999" class="form-control" placeholder="20000000" autocomplete="off" value="">
                                                                </div>
                                                            </div>
                                                        </div>
...
//<!-- для добавления поле видео --> 
    $(document).on('click', '.for_youtube_video', function(){   
            var clicks = 1;
            if (document.getElementById("clicks").innerHTML < 50){
                clicks += 1;
                document.getElementById("clicks").innerHTML = clicks;
                
                $("#linksTable").append('<tr><td class="pt-0 pb-0 pl-0 pr-0"><div class="border shadow-sm two2 required ml-0 mr-0 pt-2 pb-3 pr-2 pl-2 mb-3" id="" style="border-radius: 3px;"><div class="card-header ui-sortable-handle pt-0 pr-0 pl-0 pb-2" style="border-bottom: none;"><p class="card-title" style=" font-size: 16px;">ФИО</p><div class="card-tools"><button type="button" class="btn btn-tool remove-tr" onClick="clickM()" title="Удалить поле"><i class="fas fa-trash"></i></button></div></div><div class="row"><div class="col-md-10"><div class="block-text2" id="block-2" style="display: block;"><input type="text" name="fio[]" maxlength="100" class="form-control" placeholder="ФИО" required autocomplete="off"><div class="invalid-feedback">ФИО жазылган жок</div></div></div><div class="col-md-2"><div class="block-text2" id="block-2" style="display: block;"><input type="number" name="number[]" min="20000000" max="99999999" class="form-control" placeholder="20000000" autocomplete="off"  value=""></div></div></div></div></td></tr>');
                ...
                Toast3.fire({icon: 'success', title: 'Кошулду'});  
            }
            else{
                Swal.fire({
                  icon: 'error',
                  title: '<h4 class="modal-title">Стоп!</h4>',
                  text: 'Уже добавлено 50 поле',
                  showConfirmButton: false,
                  timer: 3000,
...
//<!-- для удаления поле видео --> 
    $(document).on('click', '.remove-tr', function(){
        ...
        Toast2.fire({icon: 'success', title: 'Өчүрүлдү'});   
    });
//<!-- для удаления поле видео --> 

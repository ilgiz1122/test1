...
<div class="content">
    <div class="content-header pl-0 pr-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{$podcategories->title}} (оңдоо)</li>
            </ol>  
                        ...
                        <div class="card card-outline card-info">
                            ...
                            @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group mt-4 pt-3" style="border-radius: 3px;">
                                        <p class="mb-1"><b>Картинка</b> (для карточки курса)</p>
                                        <div class="custom-file">

                                            <input type="file" class="custom-file-input" id="rebate_imag" name="rebate_imag" accept=".jpeg, .jpg, .tiff, .png, .gif, .webp" title="Изменить">

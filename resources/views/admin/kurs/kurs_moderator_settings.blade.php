                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          @if($moderator2 != null)
                            @if($moderator2->kurs_plus_code === 1)
                            <i class="far fa-check-circle pr-2" style="color: #28a745;"></i>
                              ...
                              @if($moderator->f_fio != null) data-fio_2="{{$moderator->f_fio}} {{$moderator->i_fio}} {{$moderator->o_fio}}" @else data-fio_2="{{$moderator->name}}" @endif data-id2="{{route('admin_kurs_moderators_settings_minus', ['user_id' => $moderator->id])}}">
                                <i class="fas fa-times" style="color: red;"></i>
                              </a>
                            @else
                              <a type="button" class="for_plus_moderator" data-toggle="modal" data-target="#staticBackdrop" 
                              @if($moderator->f_fio != null) data-fio_1="{{$moderator->f_fio}} {{$moderator->i_fio}} {{$moderator->o_fio}}" @else data-fio_1="{{$moderator->name}}" @endif data-id1="{{route('admin_kurs_moderators_settings_plus', ['user_id' => $moderator->id])}}">
            ...
            <div class="modal-dialog modal-dialog-top">  
                <div class="modal-content bg-default">
                    ...
                    <div class="modal-body">
                      ...
                      <p class="mb-0 pt-1">Курска бекер коддорду кошуу мүмкүнчүлүгүн берүү</p>
            ...
            <div class="modal-dialog modal-dialog-top">  
                <div class="modal-content bg-default">
                    ...
                    <div class="modal-body">
                      ...
                      <p class="mb-0 pt-1">Курска бекер коддорду кошуу мүмкүнчүлүгүн жокко чыгаруу</p>

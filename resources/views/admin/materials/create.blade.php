                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card card-outline card-primary">
                            ...
                            <form id="fileUploadForm" action="{{ route('materialy.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="chous mb-0" for="uploadInput">Выберите материал</label>
                                        <input class="my2 input" name="ssylka" id="uploadInput" type="file">
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="form-group col-md-4 mb-0">
                                            ...
                                            <input type="file" class="my" id="rebate_imag" name="rebate_imag"/>
                                        </div>
                                        <div class="form-group col-md-4 mb-0">
                                            <label for="rebate_imag1" class="chous mb-0">Выберите фото</label>
                                            <input type="file" class="my" id="rebate_imag1" name="rebate_imag1"/>
                                        </div>
                                        <div class="form-group col-md-4 mb-0">
                                            <label for="rebate_imag2" class="chous mb-0">Выберите фото</label>
                                            <input type="file" class="my" id="rebate_imag2" name="rebate_imag2"/>
                                        </div>
                                    </div>
                                </div>

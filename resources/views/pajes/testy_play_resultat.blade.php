    ...
    <!-- Тема -->
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-9">
                        <h5 class="mb-0 pl-2">{{$tests->title}}</h5>
                        <div class="container-fluid mt-4">
                            <div class="card card-light">
                                <div class="card-header">
                                    <h7 class="mb-0 pt-3"><b>Тесттин жыйынтыгы</b><span class="float-right text-muted">Попытка: {{$test_controls_one['popytka']}}</span></h7>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body pr-3 pl-3 pt-3 pb-3">
                                                <h7 class="mb-0 pt-3 text-muted">Туура жооптордун саны:<span class="float-right">{{$test_controls_one->kol_pravilnyh_otvetov}} <small class="text-muted">/ {{$tests->test_voprosy_count}}</small></span></h7><hr class="mt-0 mb-4">
                                                <h7 class="mb-0 pt-3 text-muted">Топтолгон баллдын саны:<span class="float-right">
                                                    ...
                                                    @endif</small></span></h7><hr class="mt-0 mb-4">
                                                <h7 class="mb-0 pt-3 text-muted">Проценти:<span class="float-right">{{round(($test_controls_one->kol_ballov_usera * 100) / $test_controls_one->test_summa_ballov)}}%</span></h7><hr class="mt-0 mb-4">
                                                <h7 class="mb-0 pt-3 text-muted">Коротулган убакыт:<span class="float-right">{{date("H:i:s", $time)}}</span></h7><hr class="mt-0 mb-0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <p class="mb-0 float-right text-muted">Тапшырган датасы: {{$test_controls_one['updated_at']->format('d.m.Y')}} <small>({{$test_controls_one['updated_at']->format('H:i:s')}})</small></p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr class="vopros_testa">
                                            <td class="pt-2 pb-0 pr-0 pl-0">
                                                <?php
                                                    ...
                                                    $nomer23 = $test_otvety->where('test_voprosy_id', $test_voprosy->id)->where('status_otveta', 1)->first();
                                                ?>
                                                        ...
                                                        <div class="row align-items-center">
                                                                ...
                                                                <p class="mb-0">
                                                                    @if($nomer22 != null)
                                                                        @if ($nomer23->id === $nomer22->otvet_id)
                                                                            <i class="pl-2 fas fa-check" style="color: #28a745;"></i>
                                                                        @else
                                                                            <i class="pl-2 fas fa-times" style="color: red;"></i>
                                                                        @endif
                                                                    @else
                                                                        <i class="fas fa-question" style="color: blueviolet;"></i>
                                                                    @endif
                                                            </div>
                                                            <div class="col text-right text-muted">
                                                                <p class="mb-0">
                                                                    @if($nomer22 != null)
                                                                        @if ($nomer23->id === $nomer22->otvet_id)
                                                                            @if($summa_ballov / $tests->test_voprosy_count >= 1 ){{$test_voprosy->ball}} @else 1 @endif
                                                                        @else
                                                                            0
                                                                        @endif
                                                                    @else
                                                                        0
                                                                    @endif
                                                                    <small> / @if($summa_ballov / $tests->test_voprosy_count >= 1 ){{$test_voprosy->ball}} @else 1 @endif балл</small></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col p-0">
                                                               <label class="t-radio__control mb-0 pr-0 pl-0">
                                                                <?php
                                                                    $nomer22 = $test_controls_variants->where('vopros_id', $test_voprosy->id)->first();
                                                                ?>
                                                                    <input type="radio" name="otvet_{{rand(1, 1000)}}[]" data-tilda-req="1" class="t-radio js-tilda-rule" hidden="">
                        ...
                        @if(intval($tests->pokaz_otvetov) > 0)
                            ...
                            @else
                                ...
                                <p class="mb-0 pl-2 pt-2">
                                    @if($day001 > 0){{$day001}} күн 
                                        @else
                                          @if($hour001 > 0){{$hour001}} саат 
                                          @else
                                            @if($minute001 > 0){{$minute001}} минутадан @endif
                                          @endif
                                    @endif кийин көрө аласыз.</p>
                            @endif
                        @endif
                        @endif
                    </div><!-- /.col -->
                    <div class="col-md-3">
                        <div class="sticky-top mb-3">
                            ...
                            <p class="mb-0 text-muted text-center" style="line-height: 0.9em;"><small>Ийгилик каалайбыз!</small></p>                            
                        </div>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
var chartSpeed = Highcharts.chart('container-speed', Highcharts.merge(gaugeOptions, {
  ...
  series: [{
    name: 'Speed',
    data: [{{round(($test_controls_one->kol_ballov_usera * 100) / $test_controls_one->test_summa_ballov)}}],
    dataLabels: {
      format:

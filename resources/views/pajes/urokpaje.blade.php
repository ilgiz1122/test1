            ...
            <div class="bs-stepper-content p-0 mt-4">
                  ...
                  <div class="card card-primary card-outline for_peremestit">
                    ...
                    <div class="card-body pb-0 pt-3 pr-2 pl-2 class11">
                      ...
                      @if(\Auth::user()->id == $podcategory->user_id)
                        ...
                        <div class="col-md-10">
                          <p class="mb-2">Сиз модератор болуп кирдиңиз</p>
                        </div>
              ...
              <div id="test-nlf-0002" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepper3trigger0002">
                <div class="row align-items-center mt-2 mb-4">
                  <div class="col-md-8">
                    <p class="pt-2"><b>Тапшырма:</b> <small class="">(max: {{$zadanie->ball}} балл)</small></span>
                  </div>
                      ...
                      @if($kupits->srok_dostupa == 0)
                        @if($zadanie_otvety != null)
                          ...
                          @if($progress->status_vypol_zadanii == 1)
                            ...
                            @php
                                $text_zadanie_otvety = $zadanie_otvety->comment;
                                $text_zadanie_otvety = preg_replace('/\b(https?:\/\/[\S]+)/si', '<a target="_blank"  href="$1">$1</a>', $text_zadanie_otvety);
                            @endphp
                            <p class="m-0">Комментарий: {!!$text_zadanie_otvety!!}</p>
                            @endif
                          ...
                          <p class="mb-0 mt-5"><b>Азаматсыз (тапшырма туура аткарылган)</b></p>
                          ...
                          <p class="mb-0 mt-5"><b>Тапшырма туура эмес аткарылган.</b> <small>(Тапшырманы кайра сөзсүз жөнөтүңүз!)</small></p>
                            @if($zadanie_otvety->comment != null)
                            @php
                                $text_zadanie_otvety = $zadanie_otvety->comment;
                                $text_zadanie_otvety = preg_replace('/\b(https?:\/\/[\S]+)/si', '<a target="_blank"  href="$1">$1</a>', $text_zadanie_otvety);

                    ...
                    @foreach ($tests as $test)
                        <div class="col-md-3 d-flex px-lg-3 py-lg-2">
                            <div class="card shadow-sm flex-fill two block23">
                                ...
                                @if ($for_action == 1)
                                    <a style="display:block" href="{{ route('ort_negizgi_test_opentest', ['subdomain' => 'ort', 'for_action' => $for_action, 'id' => $test->id]) }}"></a>
                                @endif
                                @if ($for_action == 2)
                                    <a style="display:block" href="{{ route('ort_predmettik_test_opentest', ['subdomain' => 'ort', 'for_action' => $for_action, 'id' => $test->id]) }}"></a>
                                @endif
                                <div class="card-header pt-0 pb-0 pl-0 pr-0">
                                    <img class=""
                                        style="width: 100%; border-top-right-radius: 4px; border-top-left-radius: 4px;"
                                        src="https://nonsi.kg/public/storage/testy/images/thumbnail/{{ $test['img'] }}">
                                </div>
                                <div class="card-body pr-2 pl-2 pb-0" style="padding-top: 10px;">
                                    <div class="row rrttrr">
                                        <div class="col">
                                            <p class="widget-user-desc mb-0">{{ $test['title'] }}</p>
                                            <p class="text-muted mb-1"><span class="btn-tool p-0"><i
                                                        class="fas fa-user-circle"></i></span>
                                                <small>{{ $test->user['name'] }}</small>
                                            </p>
                                        </div>
                                        <div class="w-100"></div>
                                        <div class="col align-self-end">
                                            <p class="text-muted mb-0"><small>Тили: @if (intval($test->language) != 4)
                                        ...
                                        <div class="col align-self-end text-center">
                                            @if (intval($test['partnerka']) === 1)
                                                <i class="fas fa-tag" style="color: #ffc107"></i>
                                            @endif
                                        </div>
                                        <div class="col align-self-end text-center">
                                            @if (intval($test['oldprice']) != 0)
                                                <span class="text-muted"><small><del>{{ $test['oldprice'] / 100 }}
                                                            сом</del></small></span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4 border-right border-top pr-1 pl-1">
                                            <div class="description-block mb-0 mt-0">
                                                ...
                                                <h5 class="description-header">
                                                    <small>{{ $test->test_voprosy_count }}</small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-4 border-top">
                                            <div class="description-block mb-0 mt-0">
                                                ...
                                                <h5 class="description-header">
                                                    <small>{{ $test->tests_kupit_count }}</small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-4 border-right border-top">
                                            <div class="description-block mb-0 mt-0">
                                                ...
                                                @else
                                                    ...
                                                    <h5 class="description-header"><small>{{ $test['price'] / 100 }}
                                                            сом</small></h5>
                                                @endif
                                            </div>
                                        </div>
                ...
                @else
                    <div class="error-page mt-5 pt-5">
                        <div class="error-content">
                            ...
                            <p>
                                Эгерде сиз өзүңүздүн тесттериңизди жайгаштырып сатууну кааласаңыз, анда биз менен <a
                                    href="{{ route('contact') }}">байланышыңыз</a>.
                            </p>
                        </div>
                    </div>
                @endif

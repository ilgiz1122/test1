                    ...
                    <div class="col-md-9">
                        <div class="card card-outline card-info">
                            <div class="card-header"> 
                                <p class="mb-0 text-center"><b>Олимпиаданы оңдоо</b></p>
                            </div>
                            <form id="fileUploadForm" action="{{ route('moderator_olimpiada_update', $olimpiada['id']) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                <div class="card-body pl-3 pr-3">
                                    <div class="form-group required mt-3 mb-0">
                                        <p class="required mb-0">Мекеменин аталышы <small>(Билим берүү борбору, мектеп, ...)</small></p>
                                            <input type="text" name="nazvanie_organizasii" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Билим берүү борбору, мектеп, ..." value="{{ $olimpiada->nazvanie_orgonizasii }}" required autocomplete="off">
                                    ...
                                    <div class="form-group required mt-5 mb-3">
                                        <p class="required mb-0">Темасы</p>
                                            <input type="text" id='files2' name="title" maxlength="100" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" placeholder="Темасын жазыңыз" value="{{ $olimpiada->title }}" required autocomplete="off">
                                    ...
                                    <div class="form-group mt-5 required">
                                        ...
                                        <div id="opisanie_text00">
                                            <div id="ttrr">
                                                <textarea name="opisanie" rows="1" id="summernote" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-0" required placeholder="Кыскача түшүндүрмөсүн жазыңыз" value="">{!! $olimpiada->opisanie !!}</textarea>
                                    ...
                                    <div class="form-row m-0">      
                                        <div class="form-group col-md-4 mb-0 required mt-5 pl-0">
                                            ...
                                            <select name="predmety" id="predmety_id" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-0" required="">
                                                ...
                                                <option value="{{$predmety['id']}}" @if($olimpiada->predmet === $predmety['id']) selected @endif>{{$predmety['title']}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-4 mb-0 required mt-5 pr-0">
                                            ...
                                            <select name="klassy" id="klassy_id" class="form-control form-control-border  pr-1 pl-1 pt-2 pb-0" required="">
                                                ...
                                                <option value="{{$klassy['id']}}" @if($olimpiada->klass === $klassy['id']) selected @endif>{{$klassy['number']}}-{{$klassy['title']}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-4 mb-0 required mt-5 pl-0">
                                            ...
                                            <select name="language" class="form-control form-control-border pr-1 pl-1 pt-2 pb-0" required="">
                                                ...
                                                <option value="{{$language->id}}" @if($olimpiada->language === $language->id) selected @endif>{{$language->language}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="required mt-5">
                                        ...
                                        <div class="form-group align-items-center mb-1">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input form-control-border" id="rebate_imag" name="img" accept=".jpeg, .jpg, .tiff, .png, .gif, .webp">
                                                <span class="custom-file-label span_img" for="rebate_imag" data-browse="Жүктөө">{{$olimpiada->img2}}</span>
                                    ...
                                    <div class="form-row m-0">      
                                        <div class="form-group col-md-6 mb-0 required mt-5">
                                            ...
                                            <div class="row align-items-end hover1">
                                              ...
                                              <div class="col pl-0">
                                                <input name="phone_for_zvonok" value="{{ $olimpiada->phone_for_zvonok }}" type="text" class="form-control color1 form-control-border  pr-1 pl-1 pt-2 pb-1" data-inputmask='"mask": "(999) 999-999"' data-mask placeholder="(700) 999-999" required="true">

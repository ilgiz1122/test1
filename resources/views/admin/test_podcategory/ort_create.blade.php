                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="m-0"><b>Добавить подкатегорию (o)</b></h5>
                        </div>
                        <form action="{{ route('test_podcat_store', ['for_action' => $for_action, 'id' => $test_categories->id]) }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <input type="number" name="cat_id" required value="{{$test_categories->id}}" hidden="">

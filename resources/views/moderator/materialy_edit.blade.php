                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card card-outline card-info">
                            ...
                            <form id="fileUploadForm2" action="{{ route('moderator_materials_update', ['for_action' => $for_action, 'id' => $materialy['id']]) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="row mt-4 pt-3">
                                        ...
                                        <div id="{{ $loop->iteration }}" class="col-md-6 col-sm-6 col-12 px-lg-2 py-lg-2 album{{ $loop->iteration }} pt-2">
                                            <div class="foto1 for_foto1">
                                                <img class="border" src="{{asset('')}}/storage/files/images/{{$img['img1']}}" style="width: 100%; border-radius: 5px;">

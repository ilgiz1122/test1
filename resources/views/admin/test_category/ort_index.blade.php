...
<style>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                    <h1 class="m-0">Категориялар (o)</h1>
                </div>
                <div class="col-auto">
                    <div class="card-tools">
                        <a class="btn btn-sm btn-success" href="{{ route('test_category_create', ['for_action' => $for_action])}}">
                    ...
                    <tbody class="align-middle">
                       @foreach ($test_categories as $test_categories)
                        <tr class="todo-list2">
                            ...
                            <td class="align-middle">{{$test_categories->test_podcategory_count}} <a class="btn btn-tool w-1001  tools2" type="button" href="{{ route('test_podcat_index', ['for_action' => $for_action, 'id' => $test_categories->id])}}"><i class="fas fa-long-arrow-alt-right" style="font-size: 1em;"></i></a></td>
                            <td class="align-middle">
                                <!--<a class="btn btn-tool w-1001  tools2" type="button" >
                                    <i class="far fa-eye" style="font-size: 1.2em;"></i>
                                </a>-->
                              
                                <a class="btn btn-tool tools2" href="{{route('test_category_edit', ['for_action' => $for_action, 'id' => $test_categories->id])}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Редактировать">
                                  <i class="far fa-edit" style="font-size: 1.2em;"></i>
                                </a>
                                <a type="button" class="btn btn-tool w-10000 w-1001 tools2" data-bs-toggle="tooltip" data-bs-placement="top" title="Удалить" data-toggle="modal" @if($test_categories->test_podcategory_count > 0) data-target="#staticBackdrop2" @else data-target="#staticBackdrop" data-title="{{$test_categories['title']}}" data-id="{{route('test_category_destroy', ['for_action' => $for_action, 'id' => $test_categories->id])}}" data-kol="{{$test_categories->test_podcategory_count}}" @endif>
